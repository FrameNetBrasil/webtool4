...
$router->delete('semanticType/{idEntityRelation}', [
...
$router->get('semanticType/{idEntity}/childAddSubType/{root}', [
...
$router->get('semanticType/{idEntity}/childGridSubType', [
...
$router->get('semanticType/{id}/semanticTypes', [
	'uses' => 'App\Http\Controllers\SemanticType\SemanticTypeController@semanticTypes',
	'as' => NULL,
	'middleware' => ['master'],
	'where' => [],
	'domain' => NULL,
...
$router->get('semanticType', [
	'uses' => 'App\Http\Controllers\SemanticType\BrowseController@browse',
	'as' => NULL,
	'middleware' => ['master'],
	'where' => [],
	'domain' => NULL,
...
$router->post('semanticType/grid', [
	'uses' => 'App\Http\Controllers\SemanticType\BrowseController@grid',
	'as' => NULL,
	'middleware' => ['master'],
	'where' => [],
	'domain' => NULL,
...
$router->post('semanticType/listForTree', [
	'uses' => 'App\Http\Controllers\SemanticType\BrowseController@listForTree',
	'as' => NULL,
	'middleware' => ['master'],
	'where' => [],
	'domain' => NULL,
...
$router->get('lemma/listForSelect', [
	'uses' => 'App\Http\Controllers\Lemma\BrowseController@listForSelect',
	'as' => NULL,
	'middleware' => ['auth'],
	'where' => [],
	'domain' => NULL,
...
$router->get('layer', [
	'uses' => 'App\Http\Controllers\Layer\LayerController@browse',
	'as' => NULL,
	'middleware' => ['admin'],
	'where' => [],
	'domain' => NULL,
