        ...
        confirm: function (_19, msg, fn) {
            ...
            _1a = $.extend({}, $.notify.defaults, {
                ...
                content: "<div class='wt-messager-confirm flex flex-row'>" +
                    ...
                    "<div>" + msg + " Confirm?</div>" +
                    "<div class='buttons'>" +
                    "<button type='button' class='wt-button wt-button-confirm-ok' onclick=\"let dlg = $('.messager-body'); let o = dlg.dialog('options'); dlg.dialog('close'); o.fn(true);\">Ok</button>" +
                    "<button type='button' class='wt-button wt-button-confirm-cancel ml-1' onclick=\"$('.messager-body').dialog('close')\">Cancel</button>" +
                    "</div></div>" +
                    "</div>",
            }, _1a);
            // if (!_1a.buttons) {
