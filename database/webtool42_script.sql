...
CREATE TABLE IF NOT EXISTS `webtool42_db`.`lexicon` (
  ...
  `isMWE` TINYINT(1) NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `webtool42_db`.`annotationset` (
  ...
  INDEX `idx_AnnotationSet_Type` (`idAnnotationStatus` ASC) VISIBLE,
  INDEX `fk_annotationset_lu1_idx` (`idLU` ASC) VISIBLE,
  INDEX `fk_annotationset_construction1_idx` (`idConstruction` ASC) VISIBLE,
  INDEX `fk_annotationset_frame1_idx` (`idFrame` ASC) VISIBLE,
  INDEX `fk_annotationset_lexicon1_idx` (`idLexicon` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `webtool42_db`.`concept` (
  ...
  INDEX `idx_Concept_Type` (`idType` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `webtool42_db`.`entry` (
  ...
  INDEX `idx_entry_entity_language` (`idEntity` ASC, `idLanguage` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `webtool42_db`.`qualia` (
  ...
  INDEX `idx_Qualia_Type` (`idType` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `webtool42_db`.`typegroup`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool42_db`.`typegroup` (
  `idTypeGroup` INT NOT NULL AUTO_INCREMENT,
  `entry` VARCHAR(255) NULL,
  `idEntity` INT(11) UNSIGNED NOT NULL,
  PRIMARY KEY (`idTypeGroup`),
  INDEX `fk_typegroup_entity1_idx` (`idEntity` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `webtool42_db`.`type` (
  ...
  INDEX `fk_typeinstance_typegroup1_idx` (`idTypeGroup` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_typeinstance_typegroup1`
    FOREIGN KEY (`idTypeGroup`)
    REFERENCES `webtool42_db`.`typegroup` (`idTypeGroup`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 114
...
CREATE TABLE IF NOT EXISTS `webtool42_db`.`staticobjectsentencemm` (
  ...
  `name` VARCHAR(2555) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci' NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `webtool42_db`.`boundingbox` (
  ...
  `height` INT NULL,
  `blocked` INT NULL,
  `isGroundTruth` INT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `webtool42_db`.`dynamicobject` (
  ...
  INDEX `idx_dynamicobject_origin` (`origin` ASC, `idLayerType` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `webtool42_db`.`annotation` (
  ...
  INDEX `idx_annotation_entity_dynamicobject` (`idDynamicObject` ASC, `idEntity` ASC) VISIBLE,
  INDEX `idx_annotation_entity_textspan` (`idEntity` ASC, `idTextSpan` ASC) VISIBLE,
  INDEX `idx_annotation_entity_staticobject` (`idEntity` ASC, `idStaticObject` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `webtool42_db`.`document_video` (
  ...
  INDEX `idx_document_video_document` (`idDocument` ASC, `idVideo` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `webtool42_db`.`document_image` (
  ...
  INDEX `idx_document_image` (`idDocument` ASC, `idImage` ASC) VISIBLE,
  INDEX `idx_image_document` (`idImage` ASC, `idDocument` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `webtool42_db`.`task_manager` (
  ...
  INDEX `fk_task_has_user_user1_idx` (`idUser` ASC) VISIBLE,
  INDEX `fk_task_has_user_task1_idx` (`idTask` ASC) VISIBLE,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool42_db`.`view_lu` (`idLanguageFrame` INT, `idFrame` INT, `frameIdEntity` INT, `frameName` INT, `idLU` INT, `name` INT, `senseDescription` INT, `active` INT, `importNum` INT, `incorporatedFE` INT, `idEntity` INT, `idLemma` INT, `idLexicon` INT, `lemmaName` INT, `idPOS` INT, `idUDPOS` INT, `idLanguage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool42_db`.`view_annotationset`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool42_db`.`view_annotationset` (`idAnnotationSet` INT, `idAnnotationStatus` INT, `lome` INT, `idEntityLU` INT, `idLU` INT, `idEntityCxn` INT, `idConstruction` INT, `idFrame` INT, `idEntityFrame` INT, `idLexicon` INT, `idEntityLexicon` INT, `idEntityType` INT, `idSentence` INT, `idDocument` INT, `idDocumentSentence` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool42_db`.`view_instantiationtype` (`idInstantiationType` INT, `entry` INT, `info` INT, `flag` INT, `idType` INT, `idTypeGroup` INT, `idColor` INT, `idEntity` INT, `name` INT, `description` INT, `idLanguage` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool42_db`.`view_concept` (`idConcept` INT, `entry` INT, `idEntity` INT, `keyword` INT, `aka` INT, `type` INT, `status` INT, `name` INT, `description` INT, `idLanguage` INT, `idType` INT, `typeName` INT, `typeDescription` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool42_db`.`view_qualia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool42_db`.`view_qualia` (`idLanguage` INT, `idQualia` INT, `type` INT, `info` INT, `infoinverse` INT, `idEntity` INT, `name` INT, `description` INT, `idType` INT, `idFrame` INT, `frameName` INT, `idFrameElement1` INT, `fe1Name` INT, `idFrameElement2` INT, `fe2Name` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool42_db`.`view_annotation_text_fe` (`idAnnotation` INT, `idTextSpan` INT, `startChar` INT, `endChar` INT, `multi` INT, `idLayer` INT, `idInstantiationType` INT, `idFrame` INT, `idFrameElement` INT, `idEntity` INT, `idColor` INT, `coreType` INT, `name` INT, `idLanguage` INT, `idAnnotationSet` INT, `idLayerType` INT, `layerOrder` INT, `layerTypeEntry` INT, `layerTypeIdEntity` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool42_db`.`view_annotation_text_ce`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool42_db`.`view_annotation_text_ce` (`idAnnotation` INT, `idTextSpan` INT, `startChar` INT, `endChar` INT, `multi` INT, `idLayer` INT, `idInstantiationType` INT, `idConstruction` INT, `idConstructionElement` INT, `idEntity` INT, `idColor` INT, `name` INT, `idLanguage` INT, `idAnnotationSet` INT, `idLayerType` INT, `layerOrder` INT, `layerTypeEntry` INT, `layerTypeIdEntity` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool42_db`.`view_annotation_text_gl`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool42_db`.`view_annotation_text_gl` (`idAnnotation` INT, `idTextSpan` INT, `startChar` INT, `endChar` INT, `multi` INT, `idLayer` INT, `idInstantiationType` INT, `idGenericLabel` INT, `idEntity` INT, `idColor` INT, `name` INT, `idLanguage` INT, `idAnnotationSet` INT, `idLayerType` INT, `layerOrder` INT, `layerTypeEntry` INT, `layerTypeIdEntity` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool42_db`.`view_staticobject_boundingbox` (`idBoundingBox` INT, `x` INT, `y` INT, `width` INT, `height` INT, `blocked` INT, `idStaticObject` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool42_db`.`view_dynamicobject_boundingbox` (`idBoundingBox` INT, `frameNumber` INT, `frameTime` INT, `x` INT, `y` INT, `width` INT, `height` INT, `blocked` INT, `idDynamicObject` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool42_db`.`view_annotation_static` (`idStaticObject` INT, `name` INT, `idAnnotationLU` INT, `idLU` INT, `lu` INT, `idUserTaskLU` INT, `idAnnotationFE` INT, `idFrameElement` INT, `idFrame` INT, `frame` INT, `fe` INT, `color` INT, `idLanguage` INT, `idUserTaskFE` INT, `idDocument` INT, `idImage` INT);
...
-- -----------------------------------------------------
-- Placeholder table for view `webtool42_db`.`view_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool42_db`.`view_type` (`idType` INT, `entry` INT, `idEntity` INT, `name` INT, `description` INT, `nick` INT, `idLanguage` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool42_db`.`view_lucandidate` (`frameName` INT, `frameCandidate` INT, `idFrame` INT, `idLUCandidate` INT, `name` INT, `senseDescription` INT, `idLemma` INT, `discussion` INT, `idDocument` INT, `idDocumentSentence` INT, `idBoundingBox` INT, `idUser` INT, `incorporatedFE` INT, `createdAt` INT, `idLexicon` INT, `lemmaName` INT, `idPOS` INT, `idUDPOS` INT, `idLanguage` INT, `userName` INT, `email` INT);
...
-- -----------------------------------------------------
-- function typegroup_create
-- -----------------------------------------------------

DELIMITER $$
USE `webtool42_db`$$
CREATE FUNCTION typegroup_create(
	par_typegroup JSON
) RETURNS INT
BEGIN
	DECLARE v_nameEn VARCHAR(255);
...
select a.idAnnotationSet, a.idAnnotationStatus, a.lome, 
	lu.idEntity idEntityLU, lu.idLU, 
    cxn.idEntity idEntityCxn, cxn.idConstruction,
	frame.idFrame, frame.idEntity idEntityFrame,
    lexicon.idLexicon, lexicon.idEntity idEntityLexicon,
	t.idEntity as idEntityType, ds.idSentence, ds.idDocument, ds.idDocumentSentence
from annotationset a 
join type t on (a.idAnnotationStatus = t.idType)
join document_sentence ds on (a.idSentence = ds.idSentence)
left join lu on (a.idLU = lu.idLU)
left join construction cxn on (a.idConstruction = cxn.idConstruction)
left join frame on (a.idFrame = frame.idFrame)
left join lexicon on (a.idLexicon = lexicon.idLexicon);
...
select t.idType as idInstantiationType,t.entry, t.info, t.flag, t.idType, t.idTypeGroup, t.idColor, t.idEntity, 
entry.name, entry.description, entry.idLanguage
from type t join typegroup on (t.idTypeGroup = typegroup.idTypeGroup)
join entry on (t.idEntity = entry.idEntity)
where (typegroup.entry = 'typ_instantiationtype');
...
select cp.idConcept, cp.entry, cp.idEntity, cp.keyword, cp.aka, cp.type, cp.status,
	entry.name, entry.description, entry.idLanguage,
	t.idType, t.name as typeName, t.description as typeDescription
from concept cp
join entry on (cp.idEntity = entry.idEntity)
join view_type t on (cp.idType = t.idType)
WHERE (entry.idLanguage = t.idLanguage);
...
CREATE  OR REPLACE VIEW `view_qualia` AS
        SELECT eq.idLanguage, q.idQualia, substr(t.entry,5,15) as type, q.info, q.infoinverse, q.idEntity, eq.name, eq.description, q.idType,
        ...
        JOIN type t on (q.idType = t.idType)
...
select a.idAnnotation, ts.idTextSpan,ts.startChar,ts.endChar,ts.multi,ts.idLayer,ts.idInstantiationType,
...
from staticobject as sob
         ...
         inner join document_sentence as ds on (ts.idSentence = ds.idSentence);
...
select bb.idBoundingBox, bb.x, bb.y, bb.width,bb.height,bb.blocked,sob.idStaticObject
from boundingbox bb
...
left join (
   select  lu.idLU, lu.idEntity, lu.name, lu.frameName, a.idAnnotation, a.idDynamicObject
   from view_lu lu
   join annotation a on (lu.idEntity = a.idEntity)
   where (a.idDynamicObject is not null)
   ) alu on (dob.idDynamicObject = alu.idDynamicObject)
left join (
	select fe.idFrameElement, fe.idFrame, fe.frameName, fe.name, color.rgbBg, fe.idLanguage, a.idAnnotation, a.idDynamicObject
	from view_frameelement fe
    join color on (fe.idColor = color.idColor)
	join annotation a on (fe.idEntity = a.idEntity)
	where (a.idDynamicObject is not null)
    ) afe  on (dob.idDynamicObject = afe.idDynamicObject)
...
select bb.idBoundingBox, bb.frameNumber, bb.frameTime, bb.x, bb.y, bb.width,bb.height,bb.blocked,dob.idDynamicObject
from boundingbox bb
...
from wordmm w
join document_sentence ds on (w.idDocumentSentence = ds.idDocumentSentence);
...
left join document_sentence ds on (w.idDocumentSentence = ds.idDocumentSentence);
...
select sob.idStaticObject, sob.name,
alu.idAnnotation as idAnnotationLU,
alu.idLU,
IF(alu.idLU,concat(alu.frameName,'.',alu.name),'') as lu,
...
left join (
   select  lu.idLU, lu.idEntity, lu.name, lu.frameName, a.idAnnotation, a.idStaticObject, a.idUserTask
   from view_lu lu
   join annotation a on (lu.idEntity = a.idEntity)
   where (a.idStaticObject is not null)
   ) alu on (sob.idStaticObject = alu.idStaticObject)
left join (
	select fe.idFrameElement, fe.idFrame, fe.frameName, fe.name, color.rgbBg, fe.idLanguage, a.idAnnotation, a.idStaticObject, a.idUserTask
	from view_frameelement fe
    join color on (fe.idColor = color.idColor)
	join annotation a on (fe.idEntity = a.idEntity)
	where (a.idStaticObject is not null)
    ) afe  on (sob.idStaticObject = afe.idStaticObject)
...
-- -----------------------------------------------------
-- View `webtool42_db`.`view_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool42_db`.`view_type`;
USE `webtool42_db`;
create or replace view view_type as
select t.idType, t.entry, t.idEntity, entry.name, entry.description, entry.nick, entry.idLanguage
from type t
join entry on (t.idEntity = entry.idEntity);
...
afe.idLanguage idLanguageFE,
agl.idAnnotation as idAnnotationGL,
agl.idGenericLabel,
IFNULL(agl.name, '') as gl,
agl.bgColor bgColorGL,
agl.fgColor fgColorGL,
...
left join (
	select gl.idGenericLabel, gl.name, color.rgbBg as bgColor, color.rgbFg as fgColor, gl.idLanguage, a.idAnnotation, a.idDynamicObject
	from genericlabel gl
    join color on (gl.idColor = color.idColor)
	join annotation a on (gl.idEntity = a.idEntity)
	where (a.idDynamicObject is not null)
    ) agl  on (dob.idDynamicObject = agl.idDynamicObject)
where (dob.origin IN (5)) 
order by dob.startTime asc,dob.endTime asc;
