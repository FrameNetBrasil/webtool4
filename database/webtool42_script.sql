...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool42_db`.`view_annotationset` (`idAnnotationSet` INT, `idAnnotationStatus` INT, `status` INT, `idEntityLU` INT, `idLU` INT, `idEntityCxn` INT, `idConstruction` INT, `idEntityTypeInstance` INT, `idDocumentSentence` INT, `idSentence` INT, `idDocument` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool42_db`.`view_annotationset_full` (`idAnnotationSet` INT, `idAnnotationStatus` INT, `status` INT, `idEntityLU` INT, `idLU` INT, `idEntityCxn` INT, `idConstruction` INT, `idEntityTypeInstance` INT, `idDocumentSentence` INT, `idSentence` INT, `idDocument` INT);
...
BEGIN 
   ...
   INSERT INTO annotation (idEntity, idUserTask, idUser, idRelationType, idTextSpan, idStaticObject, idDynamicObject, status, createdAt) 
	   values (v_idEntity, v_idUserTask, v_idUser, v_idRelationType, v_idTextSpan, v_idStaticObject, v_idDynamicObject, 'CREATED', NOW());
...
CREATE FUNCTION boundingbox_dynamic_delete(
    ...
    BEGIN
        ...
        -- DELETE FROM annotationobjectrelation WHERE (idAnnotationObject1 = v_idAnnotationObject) or (idAnnotationObject2 = v_idAnnotationObject);
        DELETE FROM dynamic_boundingbox WHERE idBoundingBox = par_idBoundingBox;	
...
select a.idAnnotationSet, a.idAnnotationStatus, a.status, lu.idEntity idEntityLU, lu.idLU, cxn.idEntity idEntityCxn, cxn.idConstruction,
	ti.idEntity as idEntityTypeInstance, a.idDocumentSentence, ds.idSentence, ds.idDocument
