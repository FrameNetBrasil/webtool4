...
-- 
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `webtool40_db` DEFAULT CHARACTER SET utf8mb4 ;
USE `webtool40_db` ;

-- -----------------------------------------------------
-- Table `webtool40_db`.`entity`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`entity` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`color`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`color` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`type` (
  ...
  CONSTRAINT `fk_Type_Entity`
    ...
    REFERENCES `webtool40_db`.`entity` (`idEntity`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 17
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`typeinstance`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`typeinstance` (
  ...
  CONSTRAINT `fk_TypeInstance_Color`
    FOREIGN KEY (`idColor`)
    REFERENCES `webtool40_db`.`color` (`idColor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_TypeInstance_Type`
    FOREIGN KEY (`idType`)
    REFERENCES `webtool40_db`.`type` (`idType`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 114
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`frame`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`frame` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`language`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`language` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`pos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`pos` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`udpos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`udpos` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`lemma`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`lemma` (
  ...
  CONSTRAINT `fk_Lemma_Language`
    ...
    REFERENCES `webtool40_db`.`language` (`idLanguage`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Lemma_POS`
    FOREIGN KEY (`idPOS`)
    REFERENCES `webtool40_db`.`pos` (`idPOS`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Lemma_UDPOS`
    FOREIGN KEY (`idUDPOS`)
    REFERENCES `webtool40_db`.`udpos` (`idUDPOS`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`lexicon_group`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`lexicon_group` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`lexicon`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`lexicon` (
  ...
  CONSTRAINT `fk_lexicon_lexicongroup1`
    ...
    REFERENCES `webtool40_db`.`lexicon_group` (`idLexiconGroup`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_lexicon_lemma1`
    FOREIGN KEY (`idLemma`)
    REFERENCES `webtool40_db`.`lemma` (`idLemma`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`lu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`lu` (
  ...
  `idForm` INT(11) NULL DEFAULT NULL,
  ...
  INDEX `idx_LU_Form` (`idForm` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_LU_Frame`
    FOREIGN KEY (`idFrame`)
    REFERENCES `webtool40_db`.`frame` (`idFrame`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_lu_lexicon1`
    ...
    REFERENCES `webtool40_db`.`lexicon` (`idLexicon`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`construction`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`construction` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`corpus`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`corpus` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`genretype`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`genretype` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`genre`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`genre` (
  ...
  CONSTRAINT `fk_Genre_GenreType`
    ...
    REFERENCES `webtool40_db`.`genretype` (`idGenreType`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 31
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`annotationobject`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`annotationobject` (
  `idAnnotationObject` INT NOT NULL AUTO_INCREMENT,
  `externalId` INT NULL,
  `type` CHAR(3) NULL,
  `createdAt` TIMESTAMP NULL,
  PRIMARY KEY (`idAnnotationObject`),
  INDEX `idx_annotationobject_type` (`type` ASC) VISIBLE,
  INDEX `idx_annotationobject_externalId` (`externalId` ASC) VISIBLE,
  INDEX `idx_annotationobject_externalId_type` (`externalId` ASC, `type` ASC) VISIBLE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_bin;
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`document`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`document` (
  ...
  INDEX `fk_document_annotationobject1_idx` (`idAnnotationObject` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Document_Corpus`
    ...
    REFERENCES `webtool40_db`.`corpus` (`idCorpus`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_Document_Genre`
    FOREIGN KEY (`idGenre`)
    REFERENCES `webtool40_db`.`genre` (`idGenre`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_document_annotationobject1`
    FOREIGN KEY (`idAnnotationObject`)
    REFERENCES `webtool40_db`.`annotationobject` (`idAnnotationObject`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 1080
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`paragraph`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`paragraph` (
  ...
  CONSTRAINT `fk_Paragraph_Document`
    ...
    REFERENCES `webtool40_db`.`document` (`idDocument`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`originmm`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`originmm` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`rls_label`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`rls_label` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`sentence`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`sentence` (
  ...
  `idAnnotationObject` INT NOT NULL,
  `idLanguage` INT(11) UNSIGNED NOT NULL,
  ...
  INDEX `fk_sentence_annotationobject1_idx` (`idAnnotationObject` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Sentence_Paragraph`
    ...
    REFERENCES `webtool40_db`.`paragraph` (`idParagraph`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_sentence_annotationobject1`
    FOREIGN KEY (`idAnnotationObject`)
    REFERENCES `webtool40_db`.`annotationobject` (`idAnnotationObject`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_sentence_originmm1`
    ...
    REFERENCES `webtool40_db`.`originmm` (`idOriginMM`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_sentence_rls_label1`
    FOREIGN KEY (`idRLSLabel`)
    REFERENCES `webtool40_db`.`rls_label` (`idRLSLabel`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`relationgroup`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`relationgroup` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`relationtype`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`relationtype` (
  ...
  CONSTRAINT `fk_RelationType_RelationGroup`
    ...
    REFERENCES `webtool40_db`.`relationgroup` (`idRelationGroup`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 215
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`annotationobjectrelation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`annotationobjectrelation` (
  `idAnnotationObjectRelation` INT NOT NULL AUTO_INCREMENT,
  `idRelationType` INT(11) UNSIGNED NOT NULL,
  `idAnnotationObject1` INT NOT NULL,
  `idAnnotationObject2` INT NOT NULL,
  INDEX `idx_annotationobjectrelation_relationtype` (`idRelationType` ASC) VISIBLE,
  PRIMARY KEY (`idAnnotationObjectRelation`),
  INDEX `fk_annotationobjectrelation_annotationobject1_idx` (`idAnnotationObject1` ASC) VISIBLE,
  INDEX `fk_annotationobjectrelation_annotationobject2_idx` (`idAnnotationObject2` ASC) VISIBLE,
  INDEX `idx_annotationobjectrelation_obj1` (`idAnnotationObject1` ASC, `idAnnotationObject2` ASC) VISIBLE,
  INDEX `idx_annotationobjectrelation_obj2` (`idAnnotationObject2` ASC, `idAnnotationObject1` ASC) VISIBLE,
  CONSTRAINT `fk_annotationobjectrelation_relationtype`
    FOREIGN KEY (`idRelationType`)
    REFERENCES `webtool40_db`.`relationtype` (`idRelationType`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_annotationobjectrelation_annotationobject1`
    FOREIGN KEY (`idAnnotationObject1`)
    REFERENCES `webtool40_db`.`annotationobject` (`idAnnotationObject`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_annotationobjectrelation_annotationobject2`
    FOREIGN KEY (`idAnnotationObject2`)
    REFERENCES `webtool40_db`.`annotationobject` (`idAnnotationObject`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`annotationset`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`annotationset` (
  ...
  `idAnnotationObjectRelation` INT NULL,
  ...
  INDEX `fk_annotationset_annotationobjectrelation1_idx` (`idAnnotationObjectRelation` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_AnnotationSet_TypeInstance`
    ...
    REFERENCES `webtool40_db`.`typeinstance` (`idTypeInstance`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_annotationset_lu1`
    FOREIGN KEY (`idLU`)
    REFERENCES `webtool40_db`.`lu` (`idLU`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_annotationset_construction1`
    FOREIGN KEY (`idConstruction`)
    REFERENCES `webtool40_db`.`construction` (`idConstruction`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_annotationset_sentence`
    FOREIGN KEY (`idSentence`)
    REFERENCES `webtool40_db`.`sentence` (`idSentence`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_annotationset_annotationobjectrelation1`
    FOREIGN KEY (`idAnnotationObjectRelation`)
    REFERENCES `webtool40_db`.`annotationobjectrelation` (`idAnnotationObjectRelation`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`ascomments`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`ascomments` (
  ...
  CONSTRAINT `fk_ASComments_AnnotationSet1`
    ...
    REFERENCES `webtool40_db`.`annotationset` (`idAnnotationSet`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 3
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`concept`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`concept` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`constructionelement`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`constructionelement` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`projectgroup`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`projectgroup` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`project`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`project` (
  ...
  INDEX `idx_project_entity` (`idEntity` ASC) VISIBLE,
  INDEX `fk_project_projectgroup1_idx` (`idProjectGroup` ASC) VISIBLE,
  CONSTRAINT `fk_project_entity1`
    FOREIGN KEY (`idEntity`)
    REFERENCES `webtool40_db`.`entity` (`idEntity`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_project_projectgroup1`
    ...
    REFERENCES `webtool40_db`.`projectgroup` (`idProjectGroup`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`dataset`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`dataset` (
  ...
  INDEX `idx_dataset_entity` (`idEntity` ASC) VISIBLE,
  INDEX `fk_dataset_project1_idx` (`idProject` ASC) VISIBLE,
  CONSTRAINT `fk_dataset_entity`
    FOREIGN KEY (`idEntity`)
    REFERENCES `webtool40_db`.`entity` (`idEntity`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_dataset_project1`
    ...
    REFERENCES `webtool40_db`.`project` (`idProject`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`image`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`image` (
  ...
  `idLanguage` INT(11) UNSIGNED NOT NULL,
  PRIMARY KEY (`idImage`),
  INDEX `fk_image_annotationobject1_idx` (`idAnnotationObject` ASC) VISIBLE,
  INDEX `fk_image_language1_idx` (`idLanguage` ASC) VISIBLE,
  INDEX `idx_image_name` (`name` ASC) VISIBLE,
  CONSTRAINT `fk_image_annotationobject1`
    FOREIGN KEY (`idAnnotationObject`)
    REFERENCES `webtool40_db`.`annotationobject` (`idAnnotationObject`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`dataset_image`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`dataset_image` (
  ...
  CONSTRAINT `fk_dataset_has_image_dataset1`
    ...
    REFERENCES `webtool40_db`.`dataset` (`idDataset`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_dataset_has_image_image1`
    FOREIGN KEY (`idImage`)
    REFERENCES `webtool40_db`.`image` (`idImage`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`document_sentence`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`document_sentence` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`documentmm`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`documentmm` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`domain`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`domain` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`entityrelation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`entityrelation` (
  ...
  CONSTRAINT `fk_entityrelation_entityrelation`
    ...
    REFERENCES `webtool40_db`.`entityrelation` (`idEntityRelation`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`entry`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`entry` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`frameelement`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`frameelement` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`layergroup`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`layergroup` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`layertype`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`layertype` (
  ...
  CONSTRAINT `fk_LayerType_LayerGroup`
    ...
    REFERENCES `webtool40_db`.`layergroup` (`idLayerGroup`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 26
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`genericlabel`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`genericlabel` (
  ...
  CONSTRAINT `fk_GenericLabel_Layertype1`
    ...
    REFERENCES `webtool40_db`.`layertype` (`idLayerType`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 860
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`gfequivalence`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`gfequivalence` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`group`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`group` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`imagemm`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`imagemm` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`layer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`layer` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`lexeme`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`lexeme` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`wordform`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`wordform` (
  ...
  CONSTRAINT `fk_WordForm_Lexeme`
    ...
    REFERENCES `webtool40_db`.`lexeme` (`idLexeme`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`lexemeentry`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`lexemeentry` (
  ...
  CONSTRAINT `fk_LexemeEntry_WordForm`
    ...
    REFERENCES `webtool40_db`.`wordform` (`idWordForm`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`luequivalence`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`luequivalence` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`pos_udpos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`pos_udpos` (
  `idPOS` INT(11) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`ptequivalence`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`ptequivalence` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`qualia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`qualia` (
  ...
  CONSTRAINT `fk_Qualia_FrameElement1`
    ...
    REFERENCES `webtool40_db`.`frameelement` (`idFrameElement`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`rls_access`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`rls_access` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`semantictype`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`semantictype` (
  ...
  CONSTRAINT `fk_SemanticType_Domain`
    ...
    REFERENCES `webtool40_db`.`domain` (`idDomain`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`sentence_translation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`sentence_translation` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`user` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`timeline`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`timeline` (
  ...
  CONSTRAINT `fk_Timeline_User`
    FOREIGN KEY (`idUser`)
    REFERENCES `webtool40_db`.`user` (`idUser`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`topframe`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`topframe` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`udfeature`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`udfeature` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`udrelation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`udrelation` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`user_group`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`user_group` (
  ...
  CONSTRAINT `fk_group_user`
    FOREIGN KEY (`idGroup`)
    REFERENCES `webtool40_db`.`group` (`idGroup`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`userannotation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`userannotation` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`valencelu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`valencelu` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`valencepattern`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`valencepattern` (
  ...
  CONSTRAINT `fk_ValencePattern_ValenceLU1`
    ...
    REFERENCES `webtool40_db`.`valencelu` (`idValenceLU`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`valencevalent`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`valencevalent` (
  ...
  CONSTRAINT `fk_ValenceValent_ValencePattern1`
    ...
    REFERENCES `webtool40_db`.`valencepattern` (`idValencePattern`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`video`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`video` (
  ...
  `idLanguage` INT(11) UNSIGNED NOT NULL,
  PRIMARY KEY (`idVideo`),
  INDEX `fk_video_annotationobject1_idx` (`idAnnotationObject` ASC) VISIBLE,
  INDEX `fk_video_language1_idx` (`idLanguage` ASC) VISIBLE,
  CONSTRAINT `fk_video_annotationobject1`
    FOREIGN KEY (`idAnnotationObject`)
    REFERENCES `webtool40_db`.`annotationobject` (`idAnnotationObject`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`wordmm`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`wordmm` (
  ...
  INDEX `fk_wordmm_annotationobjectrelation1_idx` (`idDocumentSentence` ASC) VISIBLE,
  INDEX `fk_wordmm_video1_idx` (`idVideo` ASC) VISIBLE,
  CONSTRAINT `fk_wordmm_annotationobjectrelation1`
  ...
  CONSTRAINT `fk_wordmm_video1`
    FOREIGN KEY (`idVideo`)
    REFERENCES `webtool40_db`.`video` (`idVideo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`dashboard`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`dashboard` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`staticobjectmm`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`staticobjectmm` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`staticobjectsentencemm`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`staticobjectsentencemm` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`staticsentencemm`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`staticsentencemm` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`task`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`task` (
  ...
  `idProject` INT NULL,
  PRIMARY KEY (`idTask`),
  INDEX `idx_task_entity` (`idEntity` ASC) VISIBLE,
  INDEX `fk_task_dataset1_idx` (`idDataset` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`usertask`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`usertask` (
  ...
  CONSTRAINT `fk_user_has_task_task`
    FOREIGN KEY (`idTask`)
    REFERENCES `webtool40_db`.`task` (`idTask`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`annotationmm`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`annotationmm` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`boundingbox`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`boundingbox` (
  ...
  INDEX `fk_boundingbox_annotationobject1_idx` (`idAnnotationObject` ASC) VISIBLE,
  CONSTRAINT `fk_boundingbox_annotationobject1`
    FOREIGN KEY (`idAnnotationObject`)
    REFERENCES `webtool40_db`.`annotationobject` (`idAnnotationObject`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`tokenizedsentence`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`tokenizedsentence` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`token`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`token` (
  ...
  INDEX `fk_token_annotationobject1_idx` (`idAnnotationObject` ASC) VISIBLE,
  CONSTRAINT `fk_token_tokenizedsentence1`
    FOREIGN KEY (`idTokenizedSentence`)
    REFERENCES `webtool40_db`.`tokenizedsentence` (`idTokenizedSentence`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_token_annotationobject1`
    FOREIGN KEY (`idAnnotationObject`)
    REFERENCES `webtool40_db`.`annotationobject` (`idAnnotationObject`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`dynamicobject`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`dynamicobject` (
  ...
  INDEX `fk_dynamicobject_annotationobject1_idx` (`idAnnotationObject` ASC) VISIBLE,
  INDEX `fk_dynamicobject_layertype1_idx` (`idLayerType` ASC) VISIBLE,
  CONSTRAINT `fk_dynamicobject_annotationobject1`
    FOREIGN KEY (`idAnnotationObject`)
    REFERENCES `webtool40_db`.`annotationobject` (`idAnnotationObject`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`annotation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`annotation` (
  ...
  INDEX `idx_annotationobjectentity_relationtype` (`idRelationType` ASC) VISIBLE,
  INDEX `idx_annotationobjectentity_entity` (`idEntity` ASC) VISIBLE,
  INDEX `fk_annotationobjectentity_annotationobject1_idx` (`idAnnotationObject` ASC) VISIBLE,
  INDEX `fk_annotation_usertask1_idx` (`idUserTask` ASC) VISIBLE,
  CONSTRAINT `fk_annotationobjectentity_relationtype1`
    FOREIGN KEY (`idRelationType`)
    REFERENCES `webtool40_db`.`relationtype` (`idRelationType`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_annotationobjectentity_entity1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_annotationobjectentity_annotationobject1`
    FOREIGN KEY (`idAnnotationObject`)
    REFERENCES `webtool40_db`.`annotationobject` (`idAnnotationObject`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_annotation_usertask1`
    ...
    REFERENCES `webtool40_db`.`usertask` (`idUserTask`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`staticobject`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`staticobject` (
  ...
  INDEX `fk_staticobject_annotationobject1_idx` (`idAnnotationObject` ASC) VISIBLE,
  INDEX `idx_staticobject_idFlickr30EntitiesChain` (`idFlickr30kEntitiesChain` ASC) VISIBLE,
  CONSTRAINT `fk_staticobject_annotationobject1`
    FOREIGN KEY (`idAnnotationObject`)
    REFERENCES `webtool40_db`.`annotationobject` (`idAnnotationObject`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`textspan`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`textspan` (
  ...
  INDEX `fk_textspan_annotationobject1_idx` (`idAnnotationObject` ASC) VISIBLE,
  INDEX `fk_textspan_sentence1_idx` (`idSentence` ASC) VISIBLE,
  INDEX `fk_textspan_staticobject1_idx` (`idStaticObject` ASC) VISIBLE,
  CONSTRAINT `fk_textspan_layer1`
    FOREIGN KEY (`idLayer`)
    REFERENCES `webtool40_db`.`layer` (`idLayer`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_textspan_typeinstance1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_textspan_annotationobject1`
    FOREIGN KEY (`idAnnotationObject`)
    REFERENCES `webtool40_db`.`annotationobject` (`idAnnotationObject`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_textspan_staticobject1`
    ...
    REFERENCES `webtool40_db`.`staticobject` (`idStaticObject`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`project_dataset`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`project_dataset` (
  `idProject` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`timespan`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`timespan` (
  `idTimespan` INT NOT NULL AUTO_INCREMENT,
  `startTime` FLOAT NULL,
  `endTime` FLOAT NULL,
  `idAnnotationObject` INT NOT NULL,
  PRIMARY KEY (`idTimespan`),
  INDEX `fk_timespan_annotationobject1_idx` (`idAnnotationObject` ASC) VISIBLE,
  CONSTRAINT `fk_timespan_annotationobject1`
    FOREIGN KEY (`idAnnotationObject`)
    REFERENCES `webtool40_db`.`annotationobject` (`idAnnotationObject`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`dataset_corpus`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`dataset_corpus` (
  `idCorpus` INT(11) UNSIGNED NOT NULL,
  `idDataset` INT NOT NULL,
  `isSource` TINYINT(1) NULL DEFAULT 0,
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`usertask_document`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`usertask_document` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`staticannotationmm`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`staticannotationmm` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`staticbboxmm`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`staticbboxmm` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`annotationcomment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`annotationcomment` (
  ...
  CONSTRAINT `fk_annotationcomment_dynamicobject1`
    ...
    REFERENCES `webtool40_db`.`dynamicobject` (`idDynamicObject`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`qualiarelation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`qualiarelation` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`qualiastructure`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`qualiastructure` (
  ...
  CONSTRAINT `fk_qualiastructure_qualiarelation1`
    ...
    REFERENCES `webtool40_db`.`qualiarelation` (`idQualiaRelation`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`qualiaargument`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`qualiaargument` (
  ...
  CONSTRAINT `fk_qualiaargument_qualiastructure1`
    ...
    REFERENCES `webtool40_db`.`qualiastructure` (`idQualiaStructure`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`qualialu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`qualialu` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`project_manager`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`project_manager` (
  `idProject` INT NOT NULL,
  `idUser` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`lucandidate`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`lucandidate` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`message`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`message` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`lexicon_expression`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`lexicon_expression` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`lexicon_feature`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`lexicon_feature` (
  `idLexicon` INT(11) UNSIGNED NOT NULL,
  ...
  CONSTRAINT `fk_lexicon_has_udfeature_udfeature1`
    ...
    REFERENCES `webtool40_db`.`udfeature` (`idUDFeature`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`dashboard_frame2`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`dashboard_frame2` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`dashboard_audition`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`dashboard_audition` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`dashboard_frame2ppm`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`dashboard_frame2ppm` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`dashboard_frame2nlg`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`dashboard_frame2nlg` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`dashboard_frame2gesture`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`dashboard_frame2gesture` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`dashboard_multi30k`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`dashboard_multi30k` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`lome_result`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`lome_result` (
  ...
  INDEX `fk_lome_result_annotationobjectrelation1_idx` (`idDocumentSentence` ASC) VISIBLE,
  CONSTRAINT `fk_lome_result_frame1`
    FOREIGN KEY (`idFrame`)
    REFERENCES `webtool40_db`.`frame` (`idFrame`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_lome_result_annotationobjectrelation1`
    FOREIGN KEY (`idDocumentSentence`)
    REFERENCES `webtool40_db`.`annotationobjectrelation` (`idAnnotationObjectRelation`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`lome_resultfe`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`lome_resultfe` (
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`cosine_node`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`cosine_node` (
  ...
  CONSTRAINT `fk_cosine_node_timespan1`
    ...
    REFERENCES `webtool40_db`.`timespan` (`idTimespan`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_cosine_node_concept1`
    ...
    REFERENCES `webtool40_db`.`concept` (`idConcept`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `webtool40_db`.`cosine_link`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`cosine_link` (
  ...
  CONSTRAINT `fk_cosine_link_cosine_node1`
    ...
    REFERENCES `webtool40_db`.`cosine_node` (`idCosineNode`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_entrylanguage`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_entrylanguage` (`idEntry` INT, `entry` INT, `name` INT, `description` INT, `nick` INT, `idLanguage` INT, `language` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_frame`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_frame` (`idFrame` INT, `entry` INT, `active` INT, `idEntity` INT, `name` INT, `description` INT, `idLanguage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_frameelement`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_frameelement` (`idFrame` INT, `frameEntry` INT, `frameIdEntity` INT, `frameName` INT, `idFrameElement` INT, `entry` INT, `active` INT, `idEntity` INT, `idColor` INT, `coreType` INT, `name` INT, `description` INT, `idLanguage` INT, `nameEn` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_coretype`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_coretype` (`entry` INT, `info` INT, `flag` INT, `idType` INT, `idColor` INT, `idEntity` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_lu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_lu` (`idLanguageFrame` INT, `idFrame` INT, `frameIdEntity` INT, `frameName` INT, `idLU` INT, `name` INT, `senseDescription` INT, `active` INT, `importNum` INT, `incorporatedFE` INT, `idEntity` INT, `idLemma` INT, `idLexicon` INT, `lemmaName` INT, `idPOS` INT, `idUDPOS` INT, `idLanguage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_annotationset`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_annotationset` (`idAnnotationSet` INT, `idAnnotationStatus` INT, `idEntityLU` INT, `idLU` INT, `idEntityCxn` INT, `idConstruction` INT, `idEntityTypeInstance` INT, `idDocumentSentence` INT, `idSentence` INT, `idDocument` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_construction`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_construction` (`idConstruction` INT, `entry` INT, `abstract` INT, `active` INT, `idEntity` INT, `cxIdLanguage` INT, `name` INT, `description` INT, `idLanguage` INT, `fullName` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constructionelement`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constructionelement` (`idConstruction` INT, `constructionEntry` INT, `constructionIdEntity` INT, `idConstructionElement` INT, `entry` INT, `active` INT, `idEntity` INT, `idColor` INT, `optional` INT, `head` INT, `multiple` INT, `name` INT, `description` INT, `idLanguage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_instantiationtype`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_instantiationtype` (`idInstantiationType` INT, `entry` INT, `info` INT, `flag` INT, `idTypeInstance` INT, `idType` INT, `idColor` INT, `idEntity` INT, `name` INT, `description` INT, `idLanguage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_relation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_relation` (`idEntityRelation` INT, `idRelationGroup` INT, `relationGroup` INT, `idRelationType` INT, `relationType` INT, `idEntity` INT, `prefix` INT, `nameCanonical` INT, `nameDirect` INT, `nameInverse` INT, `color` INT, `idEntity1` INT, `entity1Type` INT, `idEntity2` INT, `entity2Type` INT, `idEntity3` INT, `entity3Type` INT, `idRelation` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_layer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_layer` (`idLayer` INT, `rank` INT, `idAnnotationSet` INT, `idLayerType` INT, `entry` INT, `idEntity` INT, `layerOrder` INT, `name` INT, `description` INT, `idLanguage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constraint`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constraint` (`idConstraintInstance` INT, `entry` INT, `idConstraint` INT, `constraintType` INT, `idConstrained` INT, `constrainedType` INT, `idConstrainedBy` INT, `constrainedByType` INT, `idConstraintType` INT, `idEntity` INT, `prefix` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_valencepattern`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_valencepattern` (`idValenceLU` INT, `idFrame` INT, `idLU` INT, `idLanguage` INT, `idValencePattern` INT, `countPattern` INT, `idFrameElement` INT, `GF` INT, `GFSource` INT, `PT` INT, `luName` INT, `frameName` INT, `feName` INT, `language` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_domain`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_domain` (`idDomain` INT, `entry` INT, `idEntity` INT, `name` INT, `description` INT, `idLanguage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_wflexemelemma`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_wflexemelemma` (`idWordForm` INT, `form` INT, `md5` INT, `idLexeme` INT, `lexeme` INT, `idPOSLexeme` INT, `POSLexeme` INT, `idLanguage` INT, `idLexemeEntry` INT, `lexemeOrder` INT, `breakBefore` INT, `headWord` INT, `idLemma` INT, `lemma` INT, `idPOSLemma` INT, `POSLemma` INT, `language` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_sentence_old`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_sentence_old` (`idSentence` INT, `text` INT, `paragraphOrder` INT, `idParagraph` INT, `idLanguage` INT, `documentOrder` INT, `idDocument` INT, `documentEntry` INT, `author` INT, `idGenre` INT, `idCorpus` INT, `corpusEntry` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_concept`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_concept` (`idConcept` INT, `entry` INT, `idEntity` INT, `keyword` INT, `aka` INT, `type` INT, `status` INT, `name` INT, `description` INT, `idLanguage` INT, `idTypeInstance` INT, `tiName` INT, `tiDescription` INT, `tiNick` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_qualia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_qualia` (`idLanguage` INT, `idQualia` INT, `type` INT, `info` INT, `infoinverse` INT, `idEntity` INT, `name` INT, `description` INT, `idTypeInstance` INT, `idFrame` INT, `frameName` INT, `idFrameElement1` INT, `fe1Name` INT, `idFrameElement2` INT, `fe2Name` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_semantictype`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_semantictype` (`idSemanticType` INT, `entry` INT, `idEntity` INT, `idDomain` INT, `domainEntry` INT, `name` INT, `description` INT, `idLanguage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_group_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_group_user` (`idGroup` INT, `name` INT, `idUser` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_frame_classification`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_frame_classification` (`idSemanticType` INT, `relationType` INT, `name` INT, `idLanguage` INT, `idFrame` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constrainedby_frame`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constrainedby_frame` (`idLanguage` INT, `conName` INT, `idConstraint` INT, `idConstrained` INT, `idConstrainedBy` INT, `constrainedByType` INT, `idConstraintInstance` INT, `name` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constrainedby_construction`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constrainedby_construction` (`idLanguage` INT, `conName` INT, `idConstraint` INT, `idConstrained` INT, `idConstrainedBy` INT, `constrainedByType` INT, `idConstraintInstance` INT, `name` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constrainedby_ce`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constrainedby_ce` (`idLanguage` INT, `conName` INT, `idConstraint` INT, `idConstrained` INT, `idConstrainedBy` INT, `constrainedByType` INT, `idConstraintInstance` INT, `name` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constrainedby_semantictype`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constrainedby_semantictype` (`idLanguage` INT, `conName` INT, `idConstraint` INT, `idConstrained` INT, `idConstrainedBy` INT, `constrainedByType` INT, `idConstraintInstance` INT, `name` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constrainedby_constraint`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constrainedby_constraint` (`idLanguage` INT, `conName` INT, `idConstraint` INT, `idConstrained` INT, `idConstrainedBy` INT, `constrainedByType` INT, `idConstraintInstance` INT, `name` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constrainedby_constraint_cx`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constrainedby_constraint_cx` (`idLanguage` INT, `conName` INT, `idConstraint` INT, `idConstrained` INT, `idConstrainedBy` INT, `constrainedByType` INT, `idConstraintInstance` INT, `name` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constrainedby_lexeme`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constrainedby_lexeme` (`idLanguage` INT, `conName` INT, `idConstraint` INT, `idConstrained` INT, `idConstrainedBy` INT, `constrainedByType` INT, `idConstraintInstance` INT, `name` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constrainedby_lemma`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constrainedby_lemma` (`idLanguage` INT, `conName` INT, `idConstraint` INT, `idConstrained` INT, `idConstrainedBy` INT, `constrainedByType` INT, `idConstraintInstance` INT, `name` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constrainedby_lu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constrainedby_lu` (`idLanguage` INT, `conName` INT, `idConstraint` INT, `idConstrained` INT, `idConstrainedBy` INT, `constrainedByType` INT, `idConstraintInstance` INT, `name` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constrainedby_udfeature`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constrainedby_udfeature` (`idLanguage` INT, `conName` INT, `idConstraint` INT, `idConstrained` INT, `idConstrainedBy` INT, `constrainedByType` INT, `idConstraintInstance` INT, `name` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constrainedby_udrelation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constrainedby_udrelation` (`idLanguage` INT, `conName` INT, `idConstraint` INT, `idConstrained` INT, `idConstrainedBy` INT, `constrainedByType` INT, `idConstraintInstance` INT, `name` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constrainedby_udpos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constrainedby_udpos` (`idLanguage` INT, `conName` INT, `idConstraint` INT, `idConstrained` INT, `idConstrainedBy` INT, `constrainedByType` INT, `idConstraintInstance` INT, `name` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constrainedby_festandsforlu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constrainedby_festandsforlu` (`idLanguage` INT, `conName` INT, `idConstraint` INT, `idConstrained` INT, `idConstrainedBy` INT, `constrainedByType` INT, `idConstraintInstance` INT, `name` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constrainedby_festandsforfe`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constrainedby_festandsforfe` (`idLanguage` INT, `conName` INT, `idConstraint` INT, `idConstrained` INT, `idConstrainedBy` INT, `constrainedByType` INT, `idConstraintInstance` INT, `name` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constrainedby_lustandsforlu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constrainedby_lustandsforlu` (`idLanguage` INT, `conName` INT, `idConstraint` INT, `idConstrained` INT, `idConstrainedBy` INT, `constrainedByType` INT, `idConstraintInstance` INT, `name` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constrainedby_luequivalence`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constrainedby_luequivalence` (`idLanguage` INT, `conName` INT, `idConstraint` INT, `idConstrained` INT, `idConstrainedBy` INT, `constrainedByType` INT, `idConstraintInstance` INT, `name` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constrainedby`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constrainedby` (`*` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_relationtype`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_relationtype` (`idRelationType` INT, `entry` INT, `prefix` INT, `nameCanonical` INT, `nameDirect` INT, `nameInverse` INT, `color` INT, `idRelationGroup` INT, `idEntity` INT, `name` INT, `description` INT, `idLanguage` INT, `rgEntry` INT, `rgName` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_lemma`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_lemma` (`idLanguage` INT, `idLemma` INT, `name` INT, `idPOS` INT, `idEntity` INT, `POS` INT, `fullName` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constrainedby_qualia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constrainedby_qualia` (`idLanguage` INT, `conName` INT, `idConstraint` INT, `idConstrained` INT, `idConstrainedBy` INT, `constrainedByType` INT, `idConstraintInstance` INT, `name` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_corpus`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_corpus` (`idCorpus` INT, `active` INT, `idEntity` INT, `name` INT, `description` INT, `idLanguage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_document`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_document` (`idDocument` INT, `author` INT, `active` INT, `idGenre` INT, `idCorpus` INT, `idEntity` INT, `idAnnotationObject` INT, `corpusName` INT, `corpusDescription` INT, `name` INT, `description` INT, `idLanguage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_alloweddocs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_alloweddocs` (`idCorpus` INT, `corpusName` INT, `idDocument` INT, `documentName` INT, `idUser` INT, `idLanguage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_usertask`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_usertask` (`idUserTask` INT, `isActive` INT, `isIgnore` INT, `idUser` INT, `login` INT, `userName` INT, `email` INT, `idTask` INT, `taskName` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_sentence_document`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_sentence_document` (`idSentence` INT, `text` INT, `idLanguageSentence` INT, `idAnnotationObject` INT, `idOriginMM` INT, `idDocument` INT, `name` INT, `idLanguage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_project_docs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_project_docs` (`idProject` INT, `projectName` INT, `idProjectGroup` INT, `projectGroup` INT, `idCorpus` INT, `corpusName` INT, `idDocument` INT, `documentName` INT, `idLanguage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_object_relation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_object_relation` (`idAnnotationObjectRelation` INT, `relationGroup` INT, `idRelationType` INT, `relationType` INT, `idAnnotationObject1` INT, `object1Type` INT, `idAnnotationObject2` INT, `object2Type` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_annotation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_annotation` (`idAnnotation` INT, `idRelationType` INT, `relationType` INT, `idEntity` INT, `entityType` INT, `idAnnotationObject` INT, `objectType` INT, `idUserTask` INT, `idTask` INT, `name` INT, `idUser` INT, `idDocument` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_annotation_text_fe`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_annotation_text_fe` (`idAnnotation` INT, `idTextSpan` INT, `startChar` INT, `endChar` INT, `multi` INT, `idLayer` INT, `idInstantiationType` INT, `idAnnotationObject` INT, `idFrame` INT, `idFrameElement` INT, `idEntity` INT, `idColor` INT, `coreType` INT, `name` INT, `idLanguage` INT, `idAnnotationSet` INT, `idLayerType` INT, `layerOrder` INT, `layerTypeEntry` INT, `layerTypeIdEntity` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_annotation_text_ce`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_annotation_text_ce` (`idAnnotation` INT, `idTextSpan` INT, `startChar` INT, `endChar` INT, `multi` INT, `idLayer` INT, `idInstantiationType` INT, `idAnnotationObject` INT, `idConstruction` INT, `idConstructionElement` INT, `idEntity` INT, `idColor` INT, `name` INT, `idLanguage` INT, `idAnnotationSet` INT, `idLayerType` INT, `layerOrder` INT, `layerTypeEntry` INT, `layerTypeIdEntity` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_annotation_text_gl`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_annotation_text_gl` (`idAnnotation` INT, `idTextSpan` INT, `startChar` INT, `endChar` INT, `multi` INT, `idLayer` INT, `idInstantiationType` INT, `idAnnotationObject` INT, `idGenericLabel` INT, `idEntity` INT, `idColor` INT, `name` INT, `idLanguage` INT, `idAnnotationSet` INT, `idLayerType` INT, `layerOrder` INT, `layerTypeEntry` INT, `layerTypeIdEntity` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_document_sentence`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_document_sentence` (`idDocumentSentence` INT, `idDocument` INT, `idSentence` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_image_sentence`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_image_sentence` (`idImageSentence` INT, `idImage` INT, `idSentence` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_staticobject_textspan`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_staticobject_textspan` (`idStaticObject` INT, `idAnnotationObject` INT, `name` INT, `scene` INT, `nobndbox` INT, `startWord` INT, `endWord` INT, `idDocument` INT, `idSentence` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_staticobject_boundingbox`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_staticobject_boundingbox` (`idBoundingBox` INT, `x` INT, `y` INT, `width` INT, `height` INT, `blocked` INT, `idAnnotationObject` INT, `idStaticObject` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_lexicon`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_lexicon` (`idWordForm` INT, `form` INT, `idEntityWF` INT, `idLexiconExpression` INT, `position` INT, `breakBefore` INT, `head` INT, `idLemma` INT, `lemma` INT, `idEntityLM` INT, `idLanguageLM` INT, `idPOSLM` INT, `posLM` INT, `udPOSLM` INT, `idLU` INT, `lu` INT, `senseDescription` INT, `incorporatedFE` INT, `idFrame` INT, `idEntityLU` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_document_video`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_document_video` (`idDocumentVideo` INT, `idDocument` INT, `idVideo` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_frame_relation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_frame_relation` (`idEntityRelation` INT, `idRelationType` INT, `relationType` INT, `nameCanonical` INT, `nameDirect` INT, `nameInverse` INT, `color` INT, `f1Name` INT, `f1IdFrame` INT, `f1IdEntity` INT, `idLanguage` INT, `f2Name` INT, `f2IdFrame` INT, `f2IdEntity` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_fe_internal_relation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_fe_internal_relation` (`idEntityRelation` INT, `idRelationType` INT, `relationType` INT, `nameCanonical` INT, `nameDirect` INT, `nameInverse` INT, `color` INT, `fe1Name` INT, `fe1IdFrameElement` INT, `fe1IdEntity` INT, `fe1IdFrame` INT, `fe1CoreType` INT, `fe1IdColor` INT, `idLanguage` INT, `fe2Name` INT, `fe2IdFrameElement` INT, `fe2IdEntity` INT, `fe2IdFrame` INT, `fe2CoreType` INT, `fe2IdColor` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_fe_relation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_fe_relation` (`idEntityRelation` INT, `idRelationType` INT, `relationType` INT, `idRelation` INT, `nameCanonical` INT, `nameDirect` INT, `nameInverse` INT, `color` INT, `fe1Name` INT, `fe1IdFrameElement` INT, `fe1IdEntity` INT, `fe1IdFrame` INT, `fe1CoreType` INT, `fe1IdColor` INT, `idLanguage` INT, `fe2Name` INT, `fe2IdFrameElement` INT, `fe2IdEntity` INT, `fe2IdFrame` INT, `fe2CoreType` INT, `fe2IdColor` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_qualiastructure`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_qualiastructure` (`idQualiaStructure` INT, `idFrame` INT, `idEntity` INT, `name` INT, `idLanguage` INT, `relation` INT, `idQualiaRelation` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_qualiaargument`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_qualiaargument` (`idQualiaArgument` INT, `order` INT, `type` INT, `idQualiaStructure` INT, `feName` INT, `feCoreType` INT, `feIdColor` INT, `idLanguage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_qualialu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_qualialu` (`idQualiaLU` INT, `idLU1` INT, `lu1` INT, `idLU2` INT, `lu2` INT, `idFrameElement1` INT, `order1` INT, `type1` INT, `idFrameElement2` INT, `order2` INT, `type2` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_annotation_dynamic`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_annotation_dynamic` (`idDynamicObject` INT, `name` INT, `startFrame` INT, `endFrame` INT, `startTime` INT, `endTime` INT, `status` INT, `origin` INT, `idAnnotationLU` INT, `idLU` INT, `lu` INT, `idAnnotationFE` INT, `idFrameElement` INT, `idFrame` INT, `frame` INT, `fe` INT, `color` INT, `idLanguage` INT, `idDocument` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_dynamicobject_boundingbox`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_dynamicobject_boundingbox` (`idBoundingBox` INT, `frameNumber` INT, `frameTime` INT, `x` INT, `y` INT, `width` INT, `height` INT, `blocked` INT, `idAnnotationObject` INT, `idDynamicObject` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_sentence_timespan`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_sentence_timespan` (`idSentence` INT, `text` INT, `idLanguageSentence` INT, `idAnnotationObject` INT, `idOriginMM` INT, `idTimeSpan` INT, `startTime` INT, `endTime` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_video_dynamicobject`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_video_dynamicobject` (`idVideoDynamicObject` INT, `idVideo` INT, `idDynamicObject` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_document_wordmm`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_document_wordmm` (`idWordMM` INT, `word` INT, `startTime` INT, `endTime` INT, `origin` INT, `idDocumentSentence` INT, `idDocument` INT, `idSentence` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_video_wordmm`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_video_wordmm` (`idWordMM` INT, `word` INT, `startTime` INT, `endTime` INT, `origin` INT, `idVideo` INT, `idDocumentSentence` INT, `idDocument` INT, `idSentence` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_layertype_gl`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_layertype_gl` (`idLayerType` INT, `entry` INT, `allowsApositional` INT, `isAnnotation` INT, `layerOrder` INT, `idLayerGroup` INT, `idEntityLayerType` INT, `idGenericLabel` INT, `name` INT, `definition` INT, `example` INT, `idEntityGenericLabel` INT, `idColor` INT, `idLanguage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_layertype`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_layertype` (`idLayerType` INT, `entry` INT, `allowsApositional` INT, `isAnnotation` INT, `layerOrder` INT, `idLayerGroup` INT, `idEntity` INT, `name` INT, `description` INT, `idLanguage` INT, `layerGroup` INT, `layerGroupType` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_document_image`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_document_image` (`idDocumentImage` INT, `idDocument` INT, `idImage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_usertask_docs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_usertask_docs` (`idUserTaskDocument` INT, `idUserTask` INT, `isActive` INT, `isIgnore` INT, `idUser` INT, `login` INT, `userName` INT, `email` INT, `idTask` INT, `taskName` INT, `idDocument` INT, `documentName` INT, `idCorpus` INT, `corpusName` INT, `idLanguage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_annotation_static`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_annotation_static` (`idStaticObject` INT, `name` INT, `idAnnotationLU` INT, `idLU` INT, `lu` INT, `idUserTaskLU` INT, `idAnnotationFE` INT, `idFrameElement` INT, `idFrame` INT, `frame` INT, `fe` INT, `color` INT, `idLanguage` INT, `idUserTaskFE` INT, `idDocument` INT, `idImage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_domain_semantictype`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_domain_semantictype` (`idDomain` INT, `domainEntry` INT, `domainIdEntity` INT, `domainName` INT, `stIdEntity` INT, `stEntry` INT, `stName` INT, `idLanguage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_domain_frame`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_domain_frame` (`idDomain` INT, `domainEntry` INT, `domainIdEntity` INT, `domainName` INT, `frameIdEntity` INT, `frameEntry` INT, `frameName` INT, `idLanguage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_typeinstance`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_typeinstance` (`idTypeInstance` INT, `entry` INT, `idEntity` INT, `name` INT, `description` INT, `nick` INT, `idLanguage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_concept_relation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_concept_relation` (`idEntityRelation` INT, `idRelationType` INT, `relationType` INT, `nameCanonical` INT, `nameDirect` INT, `nameInverse` INT, `color` INT, `c1Name` INT, `c1IdConcept` INT, `c1IdEntity` INT, `c1Keyword` INT, `c1Type` INT, `c1Status` INT, `idLanguage` INT, `c2Name` INT, `c2IdConcept` INT, `c2IdEntity` INT, `c2Keyword` INT, `c2Type` INT, `c2Status` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_semantictype_relation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_semantictype_relation` (`idEntityRelation` INT, `idRelationType` INT, `relationType` INT, `nameCanonical` INT, `nameDirect` INT, `nameInverse` INT, `color` INT, `st1Name` INT, `st1IdSemanticType` INT, `st1IdEntity` INT, `idLanguage` INT, `st2Name` INT, `st2IdSemanticType` INT, `stIdEntity` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_lucandidate`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_lucandidate` (`frameName` INT, `frameCandidate` INT, `idFrame` INT, `idLUCandidate` INT, `name` INT, `senseDescription` INT, `idLemma` INT, `discussion` INT, `idDocument` INT, `idDocumentSentence` INT, `idBoundingBox` INT, `idUser` INT, `incorporatedFE` INT, `createdAt` INT, `idLexicon` INT, `lemmaName` INT, `idPOS` INT, `idUDPOS` INT, `idLanguage` INT, `userName` INT, `email` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_relationgroup`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_relationgroup` (`idRelationGroup` INT, `entry` INT, `idEntity` INT, `name` INT, `description` INT, `idLanguage` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_annotation_deixis`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_annotation_deixis` (`idDynamicObject` INT, `name` INT, `startFrame` INT, `endFrame` INT, `startTime` INT, `endTime` INT, `status` INT, `origin` INT, `idLayerType` INT, `nameLayerType` INT, `layerGroup` INT, `idLanguageLT` INT, `idAnnotationLU` INT, `idLU` INT, `lu` INT, `idAnnotationFE` INT, `idFrameElement` INT, `idFrame` INT, `frame` INT, `fe` INT, `colorFE` INT, `idLanguageFE` INT, `idAnnotationGL` INT, `idGenericLabel` INT, `gl` INT, `bgColorGL` INT, `fgColorGL` INT, `idLanguageGL` INT, `idDocument` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_construction_relation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_construction_relation` (`idEntityRelation` INT, `idRelationType` INT, `relationType` INT, `nameCanonical` INT, `nameDirect` INT, `nameInverse` INT, `color` INT, `c1Name` INT, `c1IdConstruction` INT, `c1IdEntity` INT, `cxIdLanguage` INT, `idLanguage` INT, `c2Name` INT, `c2IdConstruction` INT, `c2IdEntity` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constructionelement_relation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constructionelement_relation` (`idEntityRelation` INT, `idRelationType` INT, `relationType` INT, `idRelation` INT, `nameCanonical` INT, `nameDirect` INT, `nameInverse` INT, `color` INT, `ce1Name` INT, `ce1IdConstructionElement` INT, `ce1IdEntity` INT, `idLanguage` INT, `ce1IdColor` INT, `ce2Name` INT, `ce2IdConstructionElement` INT, `ce2IdEntity` INT, `ce2IdColor` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_sentence`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_sentence` (`idSentence` INT, `text` INT, `paragraphOrder` INT, `idParagraph` INT, `idAnnotationObject` INT, `idLanguage` INT, `idOriginMM` INT, `idRLSLabel` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_lexicon_lemma`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_lexicon_lemma` (`idLanguage` INT, `idLexicon` INT, `name` INT, `idEntity` INT, `idPOS` INT, `POS` INT, `shortName` INT, `fullName` INT, `idUDPOS` INT, `udPOS` INT, `fullNameUD` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_lexicon_expression`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_lexicon_expression` (`idLexiconExpression` INT, `idLanguage` INT, `idLemma` INT, `lemma` INT, `idEntity` INT, `idPOS` INT, `POS` INT, `fullName` INT, `idUDPOS` INT, `udPOS` INT, `fullNameUD` INT, `idForm` INT, `form` INT, `head` INT, `breakBefore` INT, `position` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_constrainedby_morpheme`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_constrainedby_morpheme` (`idLanguage` INT, `conName` INT, `idConstraint` INT, `idConstrained` INT, `idConstrainedBy` INT, `constrainedByType` INT, `idConstraintInstance` INT, `name` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_lexicon_402`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_lexicon_402` (`idWordForm` INT, `form` INT, `md5` INT, `altSpell` INT, `idEntityWF` INT, `idLexeme` INT, `lexeme` INT, `idLanguageLX` INT, `idEntityLX` INT, `posLX` INT, `idLexemeEntry` INT, `lexemeOrder` INT, `breakBefore` INT, `headWord` INT, `idLemma` INT, `lemma` INT, `idEntityLM` INT, `idLanguageLM` INT, `idPOSLM` INT, `posLM` INT, `idLU` INT, `lu` INT, `senseDescription` INT, `incorporatedFE` INT, `idFrame` INT, `idEntityLU` INT);

-- -----------------------------------------------------
-- Placeholder table for view `webtool40_db`.`view_lexicon_form`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webtool40_db`.`view_lexicon_form` (`idLanguage` INT, `idLexicon` INT, `form` INT, `idLexiconGroup` INT, `idEntity` INT, `idPOS` INT, `POS` INT, `shortName` INT, `fullName` INT, `idUDPOS` INT, `udPOS` INT, `fullNameUD` INT);
...
BEGIN 
   ...
   SET @idAnnotationObject = annotationobject_create(0,'TXS');
   INSERT INTO textspan (startChar, endChar, multi, idLayer, idInstantiationType, idAnnotationObject,idSentence) values (v_startChar, v_endChar, v_multi, v_idLayer, v_idInstantiationType, @idAnnotationObject,v_idSentence);
   SET @idTextSpan = (SELECT last_insert_id());
   RETURN @idTextSpan;
END$$
...
BEGIN 
   ...
   INSERT INTO sentence (text, idAnnotationObject, idLanguage, idRLSLabel) values (v_text, @idAnnotationObject, v_idLanguage, @idRLSLabel);
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_entrylanguage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_entrylanguage`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_frame`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_frame`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_frameelement`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_frameelement`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_coretype`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_coretype`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_lu`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_lu`;
USE `webtool40_db`;
...
select frame.idLanguage as idLanguageFrame, frame.idFrame, frame.idEntity as frameIdEntity, frame.name frameName,
    lu.idLU, lu.name, lu.senseDescription, lu.active, lu. importNum, lu.incorporatedFE, lu.idEntity, lu.idLemma, lu.idLexicon,
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_annotationset`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_annotationset`;
USE `webtool40_db`;
create or replace view view_annotationset as
select a.idAnnotationSet, a.idAnnotationStatus, lu.idEntity idEntityLU, lu.idLU, cxn.idEntity idEntityCxn, cxn.idConstruction,
	ti.idEntity as idEntityTypeInstance, a.idAnnotationObjectRelation as idDocumentSentence, ds.idSentence, ds.idDocument
from annotationset a 
join typeinstance ti on (a.idAnnotationStatus = ti.idTypeInstance)
join view_document_sentence ds on (a.idAnnotationObjectRelation = ds.idDocumentSentence)
left join lu on (a.idLU = lu.idLU)
left join construction cxn on (a.idConstruction = cxn.idConstruction);

-- -----------------------------------------------------
-- View `webtool40_db`.`view_construction`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_construction`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constructionelement`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constructionelement`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_instantiationtype`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_instantiationtype`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_relation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_relation`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_layer`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_layer`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constraint`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constraint`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_valencepattern`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_valencepattern`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_domain`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_domain`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_wflexemelemma`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_wflexemelemma`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_sentence_old`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_sentence_old`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_concept`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_concept`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_qualia`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_qualia`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_semantictype`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_semantictype`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_group_user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_group_user`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_frame_classification`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_frame_classification`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constrainedby_frame`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constrainedby_frame`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constrainedby_construction`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constrainedby_construction`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constrainedby_ce`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constrainedby_ce`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constrainedby_semantictype`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constrainedby_semantictype`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constrainedby_constraint`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constrainedby_constraint`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constrainedby_constraint_cx`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constrainedby_constraint_cx`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constrainedby_lexeme`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constrainedby_lexeme`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constrainedby_lemma`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constrainedby_lemma`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constrainedby_lu`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constrainedby_lu`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constrainedby_udfeature`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constrainedby_udfeature`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constrainedby_udrelation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constrainedby_udrelation`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constrainedby_udpos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constrainedby_udpos`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constrainedby_festandsforlu`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constrainedby_festandsforlu`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constrainedby_festandsforfe`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constrainedby_festandsforfe`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constrainedby_lustandsforlu`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constrainedby_lustandsforlu`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constrainedby_luequivalence`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constrainedby_luequivalence`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constrainedby`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constrainedby`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_relationtype`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_relationtype`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_lemma`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_lemma`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constrainedby_qualia`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constrainedby_qualia`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_corpus`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_corpus`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_document`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_document`;
USE `webtool40_db`;
create or replace view view_document as
select document.idDocument, document.author, document.active, document.idGenre, document.idCorpus, document.idEntity, document.idAnnotationObject,
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_alloweddocs`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_alloweddocs`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_usertask`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_usertask`;
USE `webtool40_db`;
CREATE  OR REPLACE VIEW `view_usertask` AS
SELECT ut.idUserTask, ut.isActive, ut.isIgnore, u.idUser, u.login, u.name userName, u.email, t.idTask, t.name taskName
FROM usertask ut 
JOIN user u on (ut.idUser = u.idUser)
JOIN task t on (ut.idTask = t.idTask);

-- -----------------------------------------------------
-- View `webtool40_db`.`view_sentence_document`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_sentence_document`;
USE `webtool40_db`;
CREATE  OR REPLACE VIEW `view_sentence_document` AS
SELECT s.idSentence, s.text, s.idLanguage as idLanguageSentence, s.idAnnotationObject, s.idOriginMM, d.idDocument, d.name, d.idLanguage
FROM view_sentence s
JOIN annotationobjectrelation r on (s.idAnnotationObject = r.idAnnotationObject2)
JOIN view_document d on (r.idAnnotationObject1 = d.idAnnotationObject);

-- -----------------------------------------------------
-- View `webtool40_db`.`view_project_docs`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_project_docs`;
USE `webtool40_db`;
CREATE  OR REPLACE VIEW `view_project_docs` AS
SELECT distinct p.idProject, p.name as projectName, p.idProjectGroup, pg.name as projectGroup,
...
JOIN view_document doc on (c.idCorpus = doc.idCorpus)
LEFT JOIN projectgroup pg on (p.idProjectGroup = pg.idProjectGroup)
WHERE (doc.idLanguage = c.idLanguage);

-- -----------------------------------------------------
-- View `webtool40_db`.`view_object_relation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_object_relation`;
USE `webtool40_db`;
CREATE  OR REPLACE VIEW `view_object_relation` AS
select aor.idAnnotationObjectRelation, rg.entry as relationGroup, rt.idRelationType, rt.entry as relationType, 
    aor.idAnnotationObject1, o1.type as object1Type, aor.idAnnotationObject2, o2.type as object2Type
from annotationobjectrelation aor 
join relationtype rt on (aor.idRelationType = rt.idRelationType)
join relationgroup rg on (rt.idRelationGroup = rg.idRelationGroup)
join annotationobject o1 on (aor.idAnnotationObject1 = o1.idAnnotationObject)
join annotationobject o2 on (aor.idAnnotationObject2 = o2.idAnnotationObject);

-- -----------------------------------------------------
-- View `webtool40_db`.`view_annotation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_annotation`;
USE `webtool40_db`;
CREATE  OR REPLACE VIEW `view_annotation` AS
select a.idAnnotation,a.idRelationType,rt.entry as relationType, a.idEntity, e.type entityType, a.idAnnotationObject, ao.type objectType, a.idUserTask, t.idTask, t.name,ut.idUser,d.idDocument
from annotation a
join relationtype rt on (a.idRelationType = rt.idRelationType)
join entity e on (a.idEntity = e.idEntity)
join annotationobject ao on (a.idAnnotationObject = ao.idAnnotationObject)
join view_object_relation or1 on (ao.idAnnotationObject = or1.idAnnotationObject2)
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_annotation_text_fe`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_annotation_text_fe`;
USE `webtool40_db`;
CREATE  OR REPLACE VIEW `view_annotation_text_fe` AS
select a.idAnnotation, ts.idTextSpan,ts.startChar,ts.endChar,ts.multi,ts.idLayer,ts.idInstantiationType,ts.idAnnotationObject,
       fe.idFrame, fe.idFrameElement, fe.idEntity, fe.idColor, fe.coreType, fe.name, fe.idLanguage,
       l.idAnnotationSet, l.idLayerType,
       lt.layerOrder, lt.entry as layerTypeEntry, lt.idEntity as layerTypeIdEntity
from textspan ts
join annotation a on (ts.idAnnotationObject = a.idAnnotationObject)
join view_frameelement fe on (a.idEntity = fe.idEntity)
join layer l on (ts.idLayer = l.idLayer)
join layertype lt on (l.idLayerType = lt.idLayerType);

-- -----------------------------------------------------
-- View `webtool40_db`.`view_annotation_text_ce`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_annotation_text_ce`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_annotation_text_gl`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_annotation_text_gl`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_document_sentence`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_document_sentence`;
USE `webtool40_db`;
CREATE  OR REPLACE VIEW `view_document_sentence` AS
-- select aor.idAnnotationObjectRelation as idDocumentSentence, d.idDocument, s.idSentence
-- from annotationobjectrelation aor
-- join document d on (aor.idAnnotationObject1 = d.idAnnotationObject)
-- join view_sentence s on (aor.idAnnotationObject2 = s.idAnnotationObject);
select ds.idDocumentSentence, ds.idDocument, ds.idSentence
from document_sentence ds;

-- -----------------------------------------------------
-- View `webtool40_db`.`view_image_sentence`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_image_sentence`;
USE `webtool40_db`;
CREATE  OR REPLACE VIEW `view_image_sentence` AS
select aor.idAnnotationObjectRelation as idImageSentence, i.idImage, s.idSentence
from annotationobjectrelation aor
join image i on (aor.idAnnotationObject1 = i.idAnnotationObject)
join view_sentence s on (aor.idAnnotationObject2 = s.idAnnotationObject);

-- -----------------------------------------------------
-- View `webtool40_db`.`view_staticobject_textspan`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_staticobject_textspan`;
USE `webtool40_db`;
CREATE  OR REPLACE VIEW `view_staticobject_textspan` AS
select sob.idStaticObject,
       sob.idAnnotationObject,
       sob.name,
       sob.scene,
       sob.nobndbox,
       ts.startWord,
...
from staticobject as sob
         inner join textspan as ts on (sob.idStaticObject = ts.idStaticObject)
         inner join view_object_relation as r on (ts.idAnnotationObject = r.idAnnotationObject2)
         inner join view_object_relation as ds on (ds.idAnnotationObject2 = r.idAnnotationObject1)
         inner join document as d on (ds.idAnnotationObject1 = d.idAnnotationObject)
         inner join view_sentence s on (r.idAnnotationObject1 = s.idAnnotationObject);

-- -----------------------------------------------------
-- View `webtool40_db`.`view_staticobject_boundingbox`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_staticobject_boundingbox`;
USE `webtool40_db`;
CREATE  OR REPLACE VIEW `view_staticobject_boundingbox` AS
select bb.idBoundingBox, bb.x, bb.y, bb.width,bb.height,bb.blocked,bb.idAnnotationObject,sob.idStaticObject
from boundingbox bb
join annotationobjectrelation aor on (bb.idAnnotationObject = aor.idAnnotationObject2)
join staticobject sob on (aor.idAnnotationObject1 = sob.idAnnotationObject);

-- -----------------------------------------------------
-- View `webtool40_db`.`view_lexicon`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_lexicon`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_document_video`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_document_video`;
USE `webtool40_db`;
CREATE  OR REPLACE VIEW `view_document_video` AS
select aor.idAnnotationObjectRelation as idDocumentVideo, d.idDocument, v.idVideo
from annotationobjectrelation aor
join document d on (aor.idAnnotationObject1 = d.idAnnotationObject)
join video v on (aor.idAnnotationObject2 = v.idAnnotationObject);

-- -----------------------------------------------------
-- View `webtool40_db`.`view_frame_relation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_frame_relation`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_fe_internal_relation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_fe_internal_relation`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_fe_relation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_fe_relation`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_qualiastructure`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_qualiastructure`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_qualiaargument`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_qualiaargument`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_qualialu`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_qualialu`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_annotation_dynamic`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_annotation_dynamic`;
USE `webtool40_db`;
CREATE  OR REPLACE VIEW `view_annotation_dynamic` AS
select dob.idDynamicObject, dob.name,
dob.startFrame,
dob.endFrame,
dob.startTime,
dob.endTime,
dob.status,
dob.origin,
alu.idAnnotation idAnnotationLU,
alu.idLU,
alu.lu,
afe.idAnnotation idAnnotationFE,
afe.idFrameElement,
afe.idFrame,
afe.frame,
afe.fe,
...
afe.idLanguage,
d.idDocument
from dynamicobject as dob
join view_object_relation or1 on (dob.idAnnotationObject = or1.idAnnotationObject2)
join view_object_relation or2 on (or1.idAnnotationObject1 = or2.idAnnotationObject2)
join document d on (or2.idAnnotationObject1 = d.idAnnotationObject)
left join (
        select a.idAnnotation, a.idAnnotationObject, lu.idLU, IF(lu.idLU,concat(lu.frameName,'.',lu.name),'') as lu
        from annotation a
        join view_lu lu on (a.idEntity = lu.idEntity)
) alu on (dob.idAnnotationObject = alu.idAnnotationObject)
left join (
        select a.idAnnotation, a.idAnnotationObject, fe.idFrameElement, fe.idFrame, IFNULL(fe.frameName, '')  as frame, IFNULL(fe.name, '') as fe, color.rgbBg as color, fe.idLanguage
        from annotation a
        join view_frameelement fe on (a.idEntity = fe.idEntity)
        join color on (fe.idColor = color.idColor
            )
) afe on (dob.idAnnotationObject = afe.idAnnotationObject)
where (or1.relationType = 'rel_video_dynobj')
and (or2.relationType = 'rel_document_video')
and (dob.origin IN (1,2))
order by dob.startTime asc,dob.endTime asc;

-- -----------------------------------------------------
-- View `webtool40_db`.`view_dynamicobject_boundingbox`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_dynamicobject_boundingbox`;
USE `webtool40_db`;
CREATE  OR REPLACE VIEW `view_dynamicobject_boundingbox` AS
select bb.idBoundingBox, bb.frameNumber, bb.frameTime, bb.x, bb.y, bb.width,bb.height,bb.blocked,bb.idAnnotationObject,dob.idDynamicObject
from boundingbox bb
join annotationobjectrelation aor on (bb.idAnnotationObject = aor.idAnnotationObject2)
join dynamicobject dob on (aor.idAnnotationObject1 = dob.idAnnotationObject);

-- -----------------------------------------------------
-- View `webtool40_db`.`view_sentence_timespan`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_sentence_timespan`;
USE `webtool40_db`;
CREATE  OR REPLACE VIEW `view_sentence_timespan` AS
SELECT s.idSentence, s.text, s.idLanguage as idLanguageSentence, s.idAnnotationObject, s.idOriginMM, t.idTimeSpan, t.startTime, t.endTime
FROM view_sentence s
JOIN annotationobjectrelation r on (s.idAnnotationObject = r.idAnnotationObject1)
JOIN timespan t on (r.idAnnotationObject2 = t.idAnnotationObject);

-- -----------------------------------------------------
-- View `webtool40_db`.`view_video_dynamicobject`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_video_dynamicobject`;
USE `webtool40_db`;
CREATE  OR REPLACE VIEW `view_video_dynamicobject` AS
select aor.idAnnotationObjectRelation as idVideoDynamicObject, v.idVideo, do.idDynamicObject
from annotationobjectrelation aor
join video v on (aor.idAnnotationObject1 = v.idAnnotationObject)
join dynamicobject do on (aor.idAnnotationObject2 = do.idAnnotationObject);

-- -----------------------------------------------------
-- View `webtool40_db`.`view_document_wordmm`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_document_wordmm`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_video_wordmm`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_video_wordmm`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_layertype_gl`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_layertype_gl`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_layertype`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_layertype`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_document_image`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_document_image`;
USE `webtool40_db`;
CREATE  OR REPLACE VIEW `view_document_image` AS
select aor.idAnnotationObjectRelation as idDocumentImage, d.idDocument, i.idImage
from annotationobjectrelation aor
join document d on (aor.idAnnotationObject1 = d.idAnnotationObject)
join image i on (aor.idAnnotationObject2 = i.idAnnotationObject);

-- -----------------------------------------------------
-- View `webtool40_db`.`view_usertask_docs`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_usertask_docs`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_annotation_static`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_annotation_static`;
USE `webtool40_db`;
CREATE  OR REPLACE VIEW `view_annotation_static` AS
select distinct sob.idStaticObject, sob.name,
 alu.idAnnotation idAnnotationLU,
 alu.idLU,
 alu.lu,
 alu.idUserTask idUserTaskLU,
 afe.idAnnotation idAnnotationFE,
 afe.idFrameElement,
 afe.idFrame,
 afe.frame,
 ...
 afe.color,
 afe.idLanguage,
 afe.idUserTask idUserTaskFE,
d.idDocument,
i.idImage
from staticobject as sob
join view_object_relation or1 on (sob.idAnnotationObject = or1.idAnnotationObject2)
join view_object_relation or2 on (or1.idAnnotationObject1 = or2.idAnnotationObject2)
join image as i on or2.idAnnotationObject2 = i.idAnnotationObject
join document d on (or2.idAnnotationObject1 = d.idAnnotationObject)
 left join (
         select a.idAnnotation, a.idAnnotationObject, lu.idLU, IF(lu.idLU,concat(lu.frameName,'.',lu.name),'') as lu, a.idUserTask
        from annotation a
         join view_lu lu on (a.idEntity = lu.idEntity)
 ) alu on (sob.idAnnotationObject = alu.idAnnotationObject)
 left join (
        select a.idAnnotation, a.idAnnotationObject, fe.idFrameElement, fe.idFrame, IFNULL(fe.frameName, '')  as frame, IFNULL(fe.name, '') as fe, color.rgbBg as color, fe.idLanguage, a.idUserTask
        from annotation a
        join view_frameelement fe on (a.idEntity = fe.idEntity)
        join color on (fe.idColor = color.idColor
            )
 ) afe on (sob.idAnnotationObject = afe.idAnnotationObject)
where (or1.relationType = 'rel_image_staobj')
and (or2.relationType = 'rel_document_image')
order by sob.idStaticObject asc;

-- -----------------------------------------------------
-- View `webtool40_db`.`view_domain_semantictype`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_domain_semantictype`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_domain_frame`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_domain_frame`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_typeinstance`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_typeinstance`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_concept_relation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_concept_relation`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_semantictype_relation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_semantictype_relation`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_lucandidate`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_lucandidate`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_relationgroup`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_relationgroup`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_annotation_deixis`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_annotation_deixis`;
USE `webtool40_db`;
...
afe.frame,
afe.fe,
afe.color as colorFE,
afe.idLanguage as idLanguageFE,
agl.idAnnotation idAnnotationGL,
agl.idGenericLabel,
agl.gl,
agl.bgColor as bgColorGL,
agl.fgColor as fgColorGL,
agl.idLanguage idLanguageGL,
d.idDocument
from dynamicobject as dob
join view_layertype lt on (dob.idLayerType = lt.idLayerType) 
join view_object_relation or1 on (dob.idAnnotationObject = or1.idAnnotationObject2)
join view_object_relation or2 on (or1.idAnnotationObject1 = or2.idAnnotationObject2)
join document d on (or2.idAnnotationObject1 = d.idAnnotationObject)
left join (
...
left join (
        select a.idAnnotation, a.idAnnotationObject, gl.idGenericLabel, IFNULL(gl.name, '') as gl, color.rgbBg as bgColor, color.rgbFg as fgColor, gl.idLanguage
        from annotation a
        join genericlabel gl on (a.idEntity = gl.idEntity)
        join color on (gl.idColor = color.idColor
            )
) agl on (dob.idAnnotationObject = agl.idAnnotationObject)
where (or1.relationType = 'rel_video_dynobj')
and (or2.relationType = 'rel_document_video')
and (dob.origin IN (5))
order by dob.startTime asc,dob.endTime asc;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_construction_relation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_construction_relation`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constructionelement_relation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constructionelement_relation`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_sentence`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_sentence`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_lexicon_lemma`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_lexicon_lemma`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_lexicon_expression`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_lexicon_expression`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_constrainedby_morpheme`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_constrainedby_morpheme`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_lexicon_402`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_lexicon_402`;
USE `webtool40_db`;
...
-- -----------------------------------------------------
-- View `webtool40_db`.`view_lexicon_form`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `webtool40_db`.`view_lexicon_form`;
USE `webtool40_db`;
...
DELIMITER $$
USE `webtool40_db`$$
CREATE DEFINER = CURRENT_USER TRIGGER `document_BEFORE_INSERT` BEFORE INSERT ON `document` FOR EACH ROW
BEGIN
	SET NEW.idAnnotationObject = annotationobject_create(0,'DOC');
END$$

USE `webtool40_db`$$
CREATE DEFINER = CURRENT_USER TRIGGER `document_AFTER_DELETE` AFTER DELETE ON `document` FOR EACH ROW
BEGIN
	DELETE FROM annotationobject where idAnnotationObject = OLD.idAnnotationObject;
END$$

USE `webtool40_db`$$
CREATE DEFINER = CURRENT_USER TRIGGER `sentence_BEFORE_INSERT` BEFORE INSERT ON `sentence` FOR EACH ROW
BEGIN
...
USE `webtool40_db`$$
CREATE DEFINER = CURRENT_USER TRIGGER `sentence_AFTER_DELETE` AFTER DELETE ON `sentence` FOR EACH ROW
BEGIN
	DELETE FROM annotationobject where idAnnotationObject = OLD.idAnnotationObject;
END$$

USE `webtool40_db`$$
CREATE DEFINER = CURRENT_USER TRIGGER `image_BEFORE_INSERT` BEFORE INSERT ON `image` FOR EACH ROW
BEGIN
IF (NEW.idAnnotationObject = 0) THEN
...
USE `webtool40_db`$$
CREATE DEFINER = CURRENT_USER TRIGGER `image_AFTER_DELETE` AFTER DELETE ON `image` FOR EACH ROW
BEGIN
	DELETE FROM annotationobject where idAnnotationObject = OLD.idAnnotationObject;
END$$

USE `webtool40_db`$$
CREATE DEFINER = CURRENT_USER TRIGGER `video_BEFORE_INSERT` BEFORE INSERT ON `video` FOR EACH ROW
BEGIN
IF (NEW.idAnnotationObject = 0) THEN
...
USE `webtool40_db`$$
CREATE DEFINER = CURRENT_USER TRIGGER `video_AFTER_DELETE` AFTER DELETE ON `video` FOR EACH ROW
BEGIN
	DELETE FROM annotationobject where idAnnotationObject = OLD.idAnnotationObject;
END$$

USE `webtool40_db`$$
CREATE DEFINER = CURRENT_USER TRIGGER `boundingbox_BEFORE_INSERT` BEFORE INSERT ON `boundingbox` FOR EACH ROW
BEGIN
IF (NEW.idAnnotationObject = 0) THEN
...
USE `webtool40_db`$$
CREATE DEFINER = CURRENT_USER TRIGGER `boundingbox_AFTER_DELETE` AFTER DELETE ON `boundingbox` FOR EACH ROW
BEGIN
   DELETE FROM annotationobject where idAnnotationObject = OLD.idAnnotationObject;
END$$
...
USE `webtool40_db`$$
CREATE DEFINER = CURRENT_USER TRIGGER `token_AFTER_DELETE` AFTER DELETE ON `token` FOR EACH ROW
BEGIN
	DELETE FROM annotationobject where idAnnotationObject = OLD.idAnnotationObject;
END$$

USE `webtool40_db`$$
CREATE DEFINER = CURRENT_USER TRIGGER `dynamicobject_BEFORE_INSERT` BEFORE INSERT ON `dynamicobject` FOR EACH ROW
BEGIN
IF (NEW.idAnnotationObject = 0) THEN
...
USE `webtool40_db`$$
CREATE DEFINER = CURRENT_USER TRIGGER `dynamicobject_AFTER_DELETE` AFTER DELETE ON `dynamicobject` FOR EACH ROW
BEGIN
	DELETE FROM annotationobject where idAnnotationObject = OLD.idAnnotationObject;
END$$

USE `webtool40_db`$$
CREATE DEFINER = CURRENT_USER TRIGGER `staticobject_BEFORE_INSERT` BEFORE INSERT ON `staticobject` FOR EACH ROW
BEGIN
IF (NEW.idAnnotationObject = 0) THEN
...
USE `webtool40_db`$$
CREATE DEFINER = CURRENT_USER TRIGGER `staticobject_AFTER_DELETE` AFTER DELETE ON `staticobject` FOR EACH ROW
BEGIN
   DELETE FROM annotationobject where idAnnotationObject = OLD.idAnnotationObject;
END$$

USE `webtool40_db`$$
CREATE DEFINER = CURRENT_USER TRIGGER `textspan_BEFORE_INSERT` BEFORE INSERT ON `textspan` FOR EACH ROW
BEGIN
IF (NEW.idAnnotationObject = 0) THEN
...
USE `webtool40_db`$$
CREATE DEFINER = CURRENT_USER TRIGGER `textspan_AFTER_DELETE` AFTER DELETE ON `textspan` FOR EACH ROW
BEGIN
	DELETE FROM annotationobject where idAnnotationObject = OLD.idAnnotationObject;
END$$

USE `webtool40_db`$$
CREATE DEFINER = CURRENT_USER TRIGGER `timespan_BEFORE_INSERT` BEFORE INSERT ON `timespan` FOR EACH ROW
BEGIN
IF (NEW.idAnnotationObject = 0) THEN
...
USE `webtool40_db`$$
CREATE DEFINER = CURRENT_USER TRIGGER `timespan_AFTER_DELETE` AFTER DELETE ON `timespan` FOR EACH ROW
BEGIN
	DELETE FROM annotationobject where idAnnotationObject = OLD.idAnnotationObject;
END$$
