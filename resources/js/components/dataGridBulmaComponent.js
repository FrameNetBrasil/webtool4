/**
 * Alpine.js DataGrid Component - Bulma Version
 * Replaces jQuery EasyUI DataGrid with modern Alpine.js implementation using Bulma CSS
 * 
 * Usage:
...
export default function dataGrid(config = {}) {
    return {
        ...
        get tableClasses() {
            ...
            if (this.striped) classes.push('is-striped');
            if (this.hoverable) classes.push('is-hoverable');
            if (this.border) classes.push('is-bordered');
        ...
        init() {
            ...
            console.log('Bulma DataGrid initialized:', {
        ...
        // Column CSS classes - Bulma version
        ...
        refresh() {
            this.$nextTick(() => {
                console.log('Bulma DataGrid refreshed');
            });
        }
    };
}