<x-layout.browser>
    <x-slot:head>
        <x-breadcrumb :sections="[['/','Home'],['','StaticEvent Annotation']]"></x-breadcrumb>
    </x-slot:head>
    <x-slot:main>
                ...
                <div class="app-search">
                    ...
                    >
                        <div class="search-input-group">
                            <form class="ui form"
                                  hx-post="/annotation/staticEvent/tree"
                                            ...
                                            <div
                                                ...
                                                @tree-item-selected.document="(event) => {
                                                    ...
                                                    if ((type === 'corpus') || (type === 'document')) {
                                                        ...
                                                        window.open(`/annotation/staticEvent/sentence/${event.detail.id}`, '_blank');
                                                    }
                                                }"
                                            >
                                                @fragment("tree")
                                                    <x-ui::tree
                                                        :title="$title ?? ''"
                                                        url="/annotation/staticEvent/tree"
                                                        :data="$data"
                                                    ></x-ui::tree>
                                                @endfragment
                                            </div>
