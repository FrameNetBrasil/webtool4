<x-layout.browser>
    <x-slot:head>
        <x-breadcrumb :sections="[['/','Home'],['','StaticBBox Annotation']]"></x-breadcrumb>
    </x-slot:head>
    <x-slot:main>
                ...
                <div class="app-search">
                    ...
                    >
                        <div class="search-input-group">
                            <form class="ui form"
                                  hx-post="/annotation/staticBBox/tree"
                                            ...
                                            <div class="search-results-tree"
                                                 ...
                                                 @tree-item-selected.document="(event) => {
                                                    ...
                                                    if (type === 'corpus') {
                                                        ...
                                                        window.open(`/annotation/staticBBox/${event.detail.id}`, '_blank');
                                                    }
                                                }"
                                            >
                                                @if(count($data) > 0)
