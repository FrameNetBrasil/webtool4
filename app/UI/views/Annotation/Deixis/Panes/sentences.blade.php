        ...
        <table id="sentenceTable"  class="ui compact striped table">
            ...
            @foreach($sentences as $idSentence => $sentence)
                <tr>
                    ...
                    <td onclick="annotation.video.gotoTime({{$sentence->startTime}})"><span class="cursor-pointer">{{$sentence->startTime}}</span></td>
                    <td onclick="annotation.video.gotoTime({{$sentence->endTime}})"><span class="cursor-pointer">{{$sentence->endTime}}</span></td>
