...
<button
    ...
    @click.prevent="manager.confirmDelete('Removing all BBoxes of object #{{$object->idDynamicObject}}.', '/annotation/dynamic/deleteAllBBoxes/{{$object->idDocument}}/{{$object->idDynamicObject}}')"
>
