<x-layout.index>
    <div class="app-layout minimal">
        ...
        <x-layout::breadcrumb
            :sections="[['/','Home'],['/manager','Manager'],['/layers','Layers'],['', 'LayerGroup #' . $layerGroup->idLayerGroup]]"
        ></x-layout::breadcrumb>
        <main class="app-main">
                    ...
                    <div class="page-object">
                        ...
                        <div class="page-object-data">
                            ...
                            <button
                                ...
                                x-data
                                @click.prevent="messenger.confirmDelete(`Removing LayerGroup '{{$layerGroup?->name}}'.`, '/layers/{{$layerGroup->idLayerGroup}}')"
                            >Delete</button>
                        </div>
                    </div>
