...
| <span class="color_experience">@experience</span>       | Eventive frames that profile the participant as an experiencer in an event or being affected by a cause or an agent.                                                                                                                                                    | FE core for entity experimenting the event ("experiencer", "perceiver", etc)   |
...
| <span class="color_relation">@relation </span>          | Frames that represent relations between entities or events.                                                                                                                                                                                                             | FEs core for related concepts and FE core joining the concepts.                |
