...
- *João viu Maria* ("João saw Maria")
- *Maria observou o pássaro* ("Maria observed the bird")
- *Eles olharam para o céu* ("They looked at the sky")

**b) Audition (ouvir, escutar, auscultar)**
- *João ouviu o barulho* ("João heard the noise")
- *Maria escutou a música* ("Maria listened to the music")

**c) Olfaction (cheirar, sentir)**
- *João cheirou a flor* ("João smelled the flower")
- *Maria sentiu o perfume* ("Maria smelled/sensed the perfume")

**d) Gustation (provar, saborear, degustar)**
- *João provou o vinho* ("João tasted the wine")
- *Maria saboreou a comida* ("Maria savored the food")

**e) Touch/Tactile (tocar, sentir, tatear)**
- *João tocou a superfície* ("João touched the surface")
...
3. **Duration**: Can be states or changes of state
   - State: *João ama Maria* (ongoing state)
   - Change: *João se apaixonou por Maria* ("João fell in love with Maria" - inchoative)
...
- *João entendeu a explicação* ("João understood the explanation")
- *Maria compreendeu o problema* ("Maria comprehended the problem")

**c) Memory/Recall (lembrar, recordar, esquecer)**
- *João lembrou do aniversário* ("João remembered the birthday")
- *Maria esqueceu a senha* ("Maria forgot the password")

**d) Thinking/Reasoning (pensar, raciocinar, refletir, considerar)**
- *João pensa sobre o futuro* ("João thinks about the future")
- *Maria reflete sobre a decisão* ("Maria reflects on the decision")

**e) Attention/Awareness (notar, perceber, reparar, atentar)**
- *João notou o erro* ("João noticed the mistake")
- *Maria percebeu a mudança* ("Maria perceived/noticed the change")

**f) Decision/Judgment (decidir, julgar, concluir, determinar)**
- *João decidiu partir* ("João decided to leave")
...
1. **Propositional content**: Typically take clausal complements
   ...
   - *João sabe que Maria viajou* ("João knows that Maria traveled")

2. **Factive vs. non-factive**:
   - Factive: *saber* presupposes truth (*João sabe que P* → P is true)
   - Non-factive: *acreditar* doesn't presuppose truth (*João acredita que P* → P may or may not be true)
...
- *Olhar* (look at): *João olhou para Maria* ("João looked at Maria")
- *Escutar* (listen to): *Maria escutou a música* ("Maria listened to the music")
- *Observar* (observe): *Pedro observou o experimento* ("Pedro observed the experiment")
- *Examinar* (examine): *O médico examinou o paciente* ("The doctor examined the patient")

**Cognition with control**:
- *Pensar* (think): *João pensou sobre o problema* ("João thought about the problem")
- *Refletir* (reflect): *Maria refletiu sobre a decisão* ("Maria reflected on the decision")
- *Considerar* (consider): *Pedro considerou as opções* ("Pedro considered the options")
- *Decidir* (decide): *Ana decidiu partir* ("Ana decided to leave")

#### Diagnostic tests

**Test 1: Imperative**
Controlled experiences can take imperative form:
```
✓ Olhe para aqui! (Look here!)
✓ Escute isto! (Listen to this!)
✓ Pense sobre isso! (Think about this!)
```

**Test 2: Purpose clauses**
Compatible with purpose expressions:
```
✓ João olhou para Maria para ver sua reação (looked in order to see)
✓ Maria escutou a música para relaxar (listened in order to relax)
```

**Test 3: Manner adverbs of intentionality**
```
✓ João olhou deliberadamente para Maria (deliberately)
✓ Maria escutou atentamente a explicação (attentively)
```

**Test 4: "Decidir" (decide to)**
Can be embedded under decision verbs:
```
✓ João decidiu olhar para o quadro (decided to look)
✓ Maria decidiu pensar sobre o assunto (decided to think)
```
...
- *Ver* (see - spontaneous): *João viu Maria* ("João saw Maria")
...
- *Amar* (love): *João ama Maria* ("João loves Maria")
...
- *Doer* (hurt): *A cabeça de João dói* ("João's head hurts")
- *Ter fome* (be hungry): *Maria tem fome* ("Maria is hungry")

**Epistemic states (passive)**:
- *Saber* (know - state): *João sabe a resposta* ("João knows the answer")
- *Lembrar* (remember - spontaneous): *Maria lembrou do evento* ("Maria remembered the event")

#### Diagnostic tests

**Test 1: Imperative**
Uncontrolled experiences resist imperatives:
```
✗ *Veja Maria! (See Maria! - odd as command, can only mean "look")
✗ *Ouça o barulho! (Hear the noise! - odd, can only mean "listen")
✗ *Ame João! (Love João! - cannot command emotion)
✗ *Tenha fome! (Be hungry! - cannot command bodily state)
```

**Test 2: Purpose clauses**
Incompatible or odd with purpose:
```
✗ *João viu Maria para percebê-la (saw in order to perceive - circular/odd)
✗ *Maria amou João para ter a emoção (loved in order to have emotion - odd)
```

**Test 3: Manner adverbs**
Incompatible with intentionality adverbs:
```
✗ *João viu Maria deliberadamente (saw deliberately - coerces to "looked")
✗ *Maria amou João intencionalmente (loved intentionally - odd)
```

**Test 4: Spontaneity**
Can be modified by spontaneity markers:
```
✓ João viu Maria de repente (saw suddenly)
✓ Maria se apaixonou sem querer (fell in love unintentionally)
```
...
- *João viu Maria* (saw Maria - person)
- *Maria ouviu o barulho* (heard the noise - sound)
- *Pedro cheirou a flor* (smelled the flower - object)

**Emotion toward entities**:
- *João ama Maria* (loves Maria - person)
- *Maria teme o cachorro* (fears the dog - animal)
- *Pedro odeia a violência* (hates violence - abstract concept)

**Cognition about entities**:
- *João conhece Paris* (knows Paris - place)
- *Maria entende matemática* (understands mathematics - domain)
- *Pedro lembra do João* (remembers João - person)
...
- *João viu Maria sair* (saw Maria leave - event)
- *Maria ouviu o vaso quebrar* (heard the vase break - event)

**Emotion triggered by events**:
- *João se alegrou com a vitória* (became happy with the victory)
- *Maria se entristeceu com a notícia* (became sad with the news)
- *Pedro se irritou com o atraso* (got irritated with the delay)

**Cognition about events**:
- *João percebeu que Maria saiu* (noticed that Maria left)
...
- *João viu que Maria estava ali* (saw that Maria was there)
- *Maria ouviu que João viajou* (heard that João traveled)

**Epistemic verbs with propositions**:
- *João sabe que Maria viajou* (knows that Maria traveled)
- *Maria acredita que João é honesto* (believes that João is honest)
- *Pedro pensa que vai chover* (thinks that it will rain)

**Emotion with propositional content**:
- *João teme que chova* (fears that it will rain)
- *Maria se alegrou porque ganhou* (became happy because she won)

**Cognitive attitudes toward propositions**:
- *João duvida que Maria venha* (doubts that Maria will come)
- *Maria espera que tudo dê certo* (hopes that everything goes well)
...
**Bodily sensations**:
- *João tem fome* (João is hungry - no external stimulus)
- *Maria está com sono* (Maria is sleepy)
- *A cabeça de Pedro dói* (Pedro's head hurts)

**Moods (non-directed emotions)**:
- *João está feliz* (João is happy - general mood, not directed at anything)
- *Maria está triste* (Maria is sad - mood state)

**Cognitive states**:
- *João sabe* (João knows - knowledge state without specified content)
...
1. **Experiencer has subject properties**:
   - Controls reflexives: *João₁ teme a si mesmo₁*
   - Subject-verb agreement: *João teme* vs. *Eles temem*

2. **Stative aspect**: Often denote states rather than events
   - *João ama Maria* (ongoing state)
   - Not punctual events

3. **Less causative**: Don't strongly imply Stimulus caused the emotion
   - *João teme o cachorro* (João's fear may be independent of dog's properties)
...
- *O cachorro assusta João* ("The dog frightens João")
- *A notícia apavorou Maria* ("The news terrified Maria")
...
- *A atitude ofendeu João* ("The attitude offended João")
...
3. **Passive-like**: Experiencer is Patient-like (affected by Stimulus)
   - Can passivize: *João foi assustado pelo cachorro*

4. **Agentivity ambiguous**: Stimulus may or may not be intentional
   - *O cachorro assustou João* (dog may or may not intend to frighten)
...
- *Pedro gosta de música* ("Pedro likes music")

**Perceptual states** (rare, mostly with adjectives):
- *João enxerga bem* ("João sees well")
...
```
✗ *João está sabendo a resposta (knowing)
✗ *Maria está amando João (loving)
✓ João sabe a resposta (knows)
✓ Maria ama João (loves)
```

**Test 2: Time span modification**
Compatible with durative expressions:
```
✓ João sabe a resposta há anos (has known for years)
✓ Maria ama João desde criança (has loved since childhood)
```

**Test 3: No agentivity**
Incompatible with agentive modifiers:
```
✗ *João sabe a resposta deliberadamente (knows deliberately - can't control knowing)
✗ *Maria ama João intencionalmente (loves intentionally - can't decide to love)
```
...
- *João viu Maria* ("João saw Maria" - punctual perception)
- *Maria ouviu o barulho* ("Maria heard the noise" - punctual hearing)

**Cognitive events (achievements)**:
- *João entendeu a explicação* ("João understood the explanation" - punctual comprehension)
- *Maria lembrou do evento* ("Maria remembered the event" - punctual recall)

**Emotional events (achievements/inchoatives)**:
- *João se apaixonou* ("João fell in love" - punctual change)
- *Maria se assustou* ("Maria got frightened" - punctual reaction)

**Perceptual activities**:
- *João olhou para Maria* ("João looked at Maria" - durative activity)
- *Maria escutou a música* ("Maria listened to the music" - durative activity)

**Cognitive activities**:
- *João pensou sobre o problema* ("João thought about the problem" - durative thinking)
- *Maria refletiu durante horas* ("Maria reflected for hours" - durative reflection)

**Diagnostic tests**:

**Test 1: Progressive compatibility**
Events allow progressive:
```
✓ João está olhando para Maria (is looking)
✓ Maria está pensando sobre o problema (is thinking)
✓ Pedro estava se apaixonando (was falling in love)
```

**Test 2: Temporal modification**
Compatible with punctual time expressions:
```
✓ João viu Maria às 3h (saw at 3pm - punctual)
✓ Maria se assustou de repente (got frightened suddenly - punctual)
```

**Test 3: Agentivity** (for controlled events)
Compatible with intentional modifiers:
```
✓ João olhou para Maria deliberadamente (looked deliberately)
✓ Maria pensou cuidadosamente (thought carefully)
```
...
- *João viu Maria sair* ("João saw Maria leave")
- Evidential: Direct visual evidence
- Highest certainty

**Auditory perception → Auditory evidence**:
- *João ouviu que Maria saiu* ("João heard that Maria left")
...
- *João percebeu/notou que Maria saiu* ("João noticed/perceived that Maria left")
...
- *João soube/ficou sabendo que Maria saiu* ("João learned/found out that Maria left")
- Evidential: Information from others
- Lower certainty than direct

**Belief/Assumption → Assumptive evidence**:
- *João acha/acredita que Maria saiu* ("João thinks/believes Maria left")
...
```
(Highest certainty)
João VIU que Maria estava grávida (saw that Maria was pregnant - visual evidence)
João PERCEBEU que Maria estava grávida (noticed - inferred from signs)
João SOUBE que Maria estava grávida (learned - told by someone)
João ACHA que Maria está grávida (thinks - belief/assumption)
(Lowest certainty)
```
...
```
✓ João viu que Maria ESTAVA grávida (indicative - certain)
✓ João sabe que Maria ESTÁ grávida (indicative - factual)
```

**Low certainty (can take subjunctive)**:
```
✓ João acha que Maria ESTÁ grávida (indicative - belief presented as fact)
✓ João duvida que Maria ESTEJA grávida (subjunctive - doubt)
```
...
```
✓ João viu Maria SAIR (bare infinitive - direct perception)
✓ João viu Maria SAINDO (gerund - ongoing perception)
```

**Reportative verbs** - require finite complement:
```
✓ João soube QUE Maria saiu (finite complement)
✗ *João soube Maria sair (no bare infinitive)
```

[//]: # (#### **7.5 Evidentiality and Frame Classification**)

[//]: # ()
[//]: # (For DAISY/FrameNet Brasil, evidential distinctions should be encoded:)

[//]: # ()
[//]: # (**Frame Features**:)

[//]: # (- `[evidential_type: visual|auditory|inferential|reportative|assumptive]`)
...
[//]: # (- Add **Source** FE for reportative frames: *João soube de Maria que...*)

[//]: # (- Add **Evidence** FE for inferential frames: *João concluiu pelo cheiro que...*)

[//]: # ()
[//]: # (**Example**: )

[//]: # (- Frame: *Perception_direct* → [evidential_type: visual/auditory, certainty: high])

[//]: # (- Frame: *Awareness* → [evidential_type: inferential, certainty: medium])

[//]: # (- Frame: *Opinion* → [evidential_type: assumptive, certainty: low])
...
| **Bodily** | Somatic | -controlled | State | ∅ or Entity | *doer, ter fome* |
...
```
✓ Olhe! (look - controlled) → Agentive experience
✗ *Veja! (see - uncontrolled, can only mean "look") → Non-agentive experience
```

### Test 4: Stimulus Requirement
Does the frame require or allow a Stimulus?
```
✓ João viu [Maria] (requires Stimulus) → Perception
✓ João tem fome (no Stimulus) → Bodily sensation
```

### Test 5: Psych Alternation
Does the verb participate in Experiencer-Subject / Stimulus-Subject alternation?
```
✓ João teme o cachorro / O cachorro assusta João → PSYCH VERB
✗ João viu Maria / *Maria viu João (no alternation with role switch) → PERCEPTION (not psych)
```
...
[//]: # (   - `[control: agentive|non-agentive]`)

[//]: # (   - `[aspect: stative|eventive]`)

[//]: # (   - `[stimulus_type: entity|event|proposition|none]`)

[//]: # (   - `[evidentiality: visual|auditory|inferential|reportative|assumptive]` &#40;for epistemic frames&#41;)

[//]: # ()
[//]: # (2. **Mark psych verb alternations** with frame relations:)

[//]: # (   - `Psych_alternation_of` linking Exp-Subj ↔ Stim-Subj variants)

[//]: # (   - Example: *Temor* &#40;fear&#41; ↔ *Susto* &#40;frighten&#41;)

[//]: # ()
[//]: # (3. **For DAISY**: Use control tests for disambiguation:)

[//]: # (   - If imperative possible → Agentive_perception frame)

[//]: # (   - If psych alternation exists → Check subject role for frame selection)

[//]: # ()
[//]: # (4. **Encode evidential information** for epistemic frames:)

[//]: # (   - Helps with certainty/reliability assessment)

[//]: # (   - Relevant for information extraction tasks)
