...
Inchoative frames foreground the **TELIC ROLE**, specifically emphasizing the **achievement of a new state** by an affected entity. 
These frames center on the Patient/Theme undergoing a transition, with the focus on the **resultant state** and the **coming-into-being** 
of that state rather than on the causer or the path of change.
...
**Lexically specified endpoint**:
The endpoint is part of the verb's lexical meaning
...
[//]: # ()
[//]: # (1. **Tag inchoative frames with subtype features**:)

[//]: # (   - `[change_type: physical|property|locational|state|existential]`)

[//]: # (   - `[gradability: punctual|gradual]`)

[//]: # (   - `[result_profiling: result|process|both]`)

[//]: # (   - `[alternation: alternating|non-alternating]`)

[//]: # (   - `[telicity: absolute_endpoint|relative_endpoint]`)

[//]: # ()
[//]: # (2. **Mark causative-inchoative pairs** with frame relation:)

[//]: # (   - `Inchoative_of` relation: *Breaking_inchoative* ↔ *Breaking_causative*)

[//]: # ()
[//]: # (3. **For DAISY**: Use result state test for disambiguation:)

[//]: # (   - If `estar + participle` natural → likely inchoative frame)

[//]: # (   - If alternates with transitive → strong inchoative indicator)

[//]: # ()
[//]: # (4. **Annotation priority**: Focus on:)

[//]: # (   - Change type &#40;affects FE structure&#41;)

[//]: # (   - Gradability &#40;affects aspectual behavior&#41;)

[//]: # (   - Alternation pattern &#40;links to causative frames&#41;)
