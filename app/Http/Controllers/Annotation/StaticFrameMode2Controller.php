...
use App\Data\Annotation\StaticFrameMode\SearchDataMode2;
...
class StaticFrameMode2Controller extends Controller
{
    ...
    {
        $search = session('searchFrame') ?? SearchDataMode2::from();
        return view("Panes.StaticFrameMode2.browse", [
            'search' => $search
        ]);
    }

    #[Post(path: '/annotation/grid/staticFrameMode2')]
    public function grid(SearchDataMode2 $search)
    {
        return view("Panes.StaticFrameMode2.grid", [
            'search' => $search
        ]);
    }

    #[Get(path: '/annotation/staticFrameMode2/listForTree')]
    public function listForTree(SearchDataMode2 $search)
    {
        $result = [];
    ...
    {
        return view("Panes.StaticFrameMode2.annotationSentence", $this->getData($idStaticSentenceMM));
    }
...
//        debug($idFrame);
        if ($idFrame != '') {
            ...
            return view("Panes.StaticFrameMode2.fes", $data);
        } else {
